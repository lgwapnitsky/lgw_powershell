...
$webexCSV = import-csv "$pwd\onemoretime.csv"
...
$results | select WebExUserName, Active, FirstName, LastName, UserName, Disabled | export-csv "$pwd\WebEx_ADDisabled.csv" -notypeinformation