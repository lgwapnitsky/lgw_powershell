IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Region_Metro_All_Lines_View_1_PANJ_Prod]'))
DROP VIEW [dbo].[Region_Metro_All_Lines_View_1_PANJ_Prod]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Region_Metro_All_Lines_View_1_PANJ_Prod]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.Region_Metro_All_Lines_View_1_PANJ_Prod
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Latest_All_Lines_View_1.Account_RepLoss_Ratio, dbo.Latest_All_Lines_View_1.CompanyCode, 
                      dbo.Latest_All_Lines_View_1.Account_RepLoss_Ratio_NonCat, 
                      dbo.Latest_All_Lines_View_1.Account_RepLoss_Ratio_NonCat_priorpolperiods_Range, 
                      dbo.Latest_All_Lines_View_1.Account_RepLoss_Ratio_priorpolperiods_Range, dbo.Latest_All_Lines_View_1.Number_of_Renewals, 
                      dbo.Latest_All_Lines_View_1.Renewals_Range, dbo.Latest_All_Lines_View_1.PICProducer, dbo.Latest_All_Lines_View_1.regiondesc
FROM         dbo.Latest_All_Lines_View_1 RIGHT OUTER JOIN
                      dbo.PICProducers_PANJ ON dbo.Latest_All_Lines_View_1.PICProducer = dbo.PICProducers_PANJ.PICProducer
WHERE     (dbo.Latest_All_Lines_View_1.Branch_Region = ''Metro'')
' 
GO
