IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[VS_EPP_Loss_Detail_Information_1]') AND type in (N'U'))
DROP TABLE [dbo].[VS_EPP_Loss_Detail_Information_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[VS_EPP_Loss_Detail_Information_1]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[VS_EPP_Loss_Detail_Information_1](
	...
	[Coverage_Group] [varchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Coverage_Reporting_group] [varchar](15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Coverage_Form] [varchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[COL_Fidelity_Other_Count] [decimal](15, 2) NULL,
	[COL_Fidelity_Other_Loss] [decimal](15, 2) NULL,
