IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_MO_Lines_Losses_View_1]'))
DROP VIEW [dbo].[State_MO_Lines_Losses_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_MO_Lines_Losses_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_MO_Lines_Losses_View_1
AS
SELECT     dbo.ALL_POLICIES_12_Detail_Information_1_March.Accountnumber, dbo.ALL_POLICIES_12_Detail_Information_1_March.Policy_Number, 
                      ...
                      dbo.ALL_POLICIES_12_Detail_Information_1_March.Premium_State, dbo.Policy_Information_ALL_POLICIES_March.BusinessClassDesc, 
                      dbo.Policy_Information_ALL_POLICIES_March.DivisionName, dbo.Policy_Information_ALL_POLICIES_March.ProductType
...
WHERE     (dbo.ALL_POLICIES_12_Detail_Information_1_March.Premium_State = ''MO'')
' 
GO
