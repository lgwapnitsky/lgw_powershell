IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_CA_All_Lines_view_1]'))
DROP VIEW [dbo].[State_CA_All_Lines_view_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_CA_All_Lines_view_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_CA_All_Lines_view_1
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_May.statecode, dbo.ALL_POLICIES_12_premium_summary_May.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_May.Source_Detail_Name
FROM         dbo.ALL_POLICIES_12_premium_summary_May LEFT OUTER JOIN
                      AccessPHLYEOM.dbo.product ON dbo.ALL_POLICIES_12_premium_summary_May.productcode = AccessPHLYEOM.dbo.product.productcode LEFT OUTER JOIN
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_May.statecode, dbo.ALL_POLICIES_12_premium_summary_May.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_May.underwriter, dbo.Policy_Information_ALL_POLICIES_May.BusinessClassDesc, 
                      dbo.Policy_Information_ALL_POLICIES_May.Source_Detail_Name
HAVING      (dbo.ALL_POLICIES_12_premium_summary_May.statecode = ''ca'') AND (dbo.ALL_POLICIES_12_premium_summary_May.Coverage_Reporting_group = ''gl'') AND 
                      (dbo.ALL_POLICIES_12_premium_summary_May.Fiscal_AY_Year > 2007) AND (AccessPHLYEOM.dbo.product.producttype <> ''u'')
' 
GO
