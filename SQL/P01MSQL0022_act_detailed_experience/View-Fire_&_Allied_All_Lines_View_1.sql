IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Fire_&_Allied_All_Lines_View_1]'))
DROP VIEW [dbo].[Fire_&_Allied_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Fire_&_Allied_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.[Fire_&_Allied_All_Lines_View_1]
AS
...
WHERE     (dbo.Latest_All_Lines_View_1.statecode IN (''PA'')) AND (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2007) AND 
                      (dbo.Latest_All_Lines_View_1.Coverage_Reporting_group IN (''Fire & Allied''))
' 
GO
