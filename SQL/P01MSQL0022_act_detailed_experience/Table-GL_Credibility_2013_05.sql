IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GL_Credibility_2013_05]') AND type in (N'U'))
DROP TABLE [dbo].[GL_Credibility_2013_05]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GL_Credibility_2013_05]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[GL_Credibility_2013_05](
