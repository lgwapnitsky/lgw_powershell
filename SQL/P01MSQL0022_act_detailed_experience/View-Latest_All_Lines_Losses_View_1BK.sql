IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_All_Lines_Losses_View_1BK]'))
DROP VIEW [dbo].[Latest_All_Lines_Losses_View_1BK]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_All_Lines_Losses_View_1BK]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW [dbo].[Latest_All_Lines_Losses_View_1BK]
AS
