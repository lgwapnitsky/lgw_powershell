IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[MD_All_Lines_View_1]'))
DROP VIEW [dbo].[MD_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[MD_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.MD_All_Lines_View_1
AS
...
WHERE     (dbo.Latest_All_Lines_View_1.productcode = ''md'')
' 
GO
