IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[NPDO_Loss_Detail_Information_2_temp]') AND type in (N'U'))
DROP TABLE [dbo].[NPDO_Loss_Detail_Information_2_temp]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[NPDO_Loss_Detail_Information_2_temp]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[NPDO_Loss_Detail_Information_2_temp](
