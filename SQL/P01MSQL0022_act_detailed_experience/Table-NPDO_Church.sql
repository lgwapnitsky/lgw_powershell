IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[NPDO_Church]') AND type in (N'U'))
DROP TABLE [dbo].[NPDO_Church]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[NPDO_Church]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[NPDO_Church](
