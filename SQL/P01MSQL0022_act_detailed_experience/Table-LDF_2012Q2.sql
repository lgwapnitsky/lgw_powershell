IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[LDF_2012Q2]') AND type in (N'U'))
DROP TABLE [dbo].[LDF_2012Q2]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[LDF_2012Q2]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[LDF_2012Q2](
