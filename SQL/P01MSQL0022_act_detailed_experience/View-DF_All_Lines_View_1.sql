IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[DF_All_Lines_View_1]'))
DROP VIEW [dbo].[DF_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[DF_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.DF_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_May.Clubs_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_May.Driving_Range_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_May.Golf_Municipal_Public_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_May.Golf_Club_Country_Club_Avg_Rate_Range, dbo.Policy_Information_Underwriting_Check_List_May.Liquor_Liability_YN, 
                      dbo.Policy_Information_GL_AVG_RATES_May.Swimming_Pools_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_May.Miniature_Golf_Avg_Rate_Range, 
                      ...
                      dbo.Latest_All_Lines_View_1.COL_Harrassment_Count, dbo.Latest_All_Lines_View_1.COL_Harrassment_Loss, dbo.Latest_All_Lines_View_1.COL_DO_Other_Count, 
                      dbo.Latest_All_Lines_View_1.COL_DO_Other_Loss, dbo.Latest_All_Lines_View_1.COL_EPL_Other_Count, dbo.Latest_All_Lines_View_1.COL_EPL_Other_Loss, 
                      ...
                      dbo.Latest_All_Lines_View_1.County_Pop_Density_Range, dbo.Policy_Information_FF_May.FF_DO_RatingClass, 
                      dbo.Policy_Information_FF_May.TrimBusiness_Type, dbo.Policy_Information_FF_May.FF_EPL_RatingClass, 
                      dbo.Policy_Information_FF_May.FF_EPL_Num_of_Employees_Range, dbo.Policy_Information_FF_May.FF_EPL_Limit, dbo.Policy_Information_FF_May.FF_DO_Limit, 
                      dbo.Policy_Information_FF_May.FF_DO_Alt_Retention_int, dbo.Policy_Information_FF_May.FF_EPL_Alt_Retention_int, 
                      dbo.Policy_Information_FF_May.FF_EPL_Limit_int, dbo.Latest_All_Lines_View_1.Bylaws_YN, dbo.Latest_All_Lines_View_1.Clean_Warranty_Letter_Received_YN, 
                      dbo.Latest_All_Lines_View_1.Disciplinary_Administrative_or_Criminal_Actions_YN, dbo.Latest_All_Lines_View_1.Disciplinary_Action_from_Peer_Review_YN, 
                      dbo.Latest_All_Lines_View_1.Employment_Application_YN, dbo.Latest_All_Lines_View_1.Employment_Handbook_YN, 
                      dbo.Latest_All_Lines_View_1.Employment_Application_Handbook_YN, dbo.Latest_All_Lines_View_1.Financials_YN, dbo.Latest_All_Lines_View_1.Form_5500_YN, 
                      dbo.Latest_All_Lines_View_1.Information_Only_YN, dbo.Latest_All_Lines_View_1.List_of_D_and_Os_YN, 
                      dbo.Latest_All_Lines_View_1.Standard_Setting_or_Member_Certification_Services_YN, dbo.Latest_All_Lines_View_1.Merger_Acquisition_or_Consolidation_YN, 
                      dbo.Latest_All_Lines_View_1.No_Loss_Letter_Received_YN, dbo.Latest_All_Lines_View_1.No_Prior_Coverage_YN, 
                      dbo.Latest_All_Lines_View_1.Magazines_Periodicals_or_Newsletters_YN, 
                      ...
                      dbo.Latest_All_Lines_View_1.Account_ProductType_P, dbo.Latest_All_Lines_View_1.Written_Premium_Range_for_Product, dbo.Policy_Information_FF_May.DF_Limit, 
                      dbo.Policy_Information_FF_May.DF_Base_Retention, dbo.Policy_Information_FF_May.DF_Alt_Retention, dbo.Policy_Information_FF_May.DF_RatingClass
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      dbo.Policy_Information_FF_May ON dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_FF_May.policynumber LEFT OUTER JOIN
...
WHERE     (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2008) AND (dbo.Latest_All_Lines_View_1.productcode = ''DF'')
' 
GO
