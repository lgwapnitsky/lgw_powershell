IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[FLEXI_Policies_for_Proposal_11]') AND type in (N'U'))
DROP TABLE [dbo].[FLEXI_Policies_for_Proposal_11]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[FLEXI_Policies_for_Proposal_11]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[FLEXI_Policies_for_Proposal_11](
	...
	[RatingClassProp(Current)] [float] NULL,
