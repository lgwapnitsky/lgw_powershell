IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_Policy_Information_Underwriting_Check_List_View_1]'))
DROP VIEW [dbo].[Latest_Policy_Information_Underwriting_Check_List_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_Policy_Information_Underwriting_Check_List_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE view dbo.Latest_Policy_Information_Underwriting_Check_List_View_1
AS
SELECT     accountnumber, policyid, policynumber, policyeffectivedate, [4Years_Hard_Copy_Loss_Runs_YN], Abuse_Molestation_YN, Adoption_YN, Asbestos_Lead_YN, 
                      ...
                      Website_Transactional_E_Commerce_YN, Attestation_Percent, Audit_Percent, Bookkeeping_Percent, Church_Members_Num, Claims_Past_5Yrs, Clergy_Num, 
                      Compilation_Percent, Corporate_Financial_Planning_Percent, Corporate_Tax_Percent, Data_Processing_Percent, Elder_Care_Percent, Employee_Salary_GT100k, 
                      Fleet_Size, Individual_Tax_Percent, Insider_Shareholder_Percent, Locations_Num, MAS_Services_Percent, Number_of_Buildings_Greater_than_3_Stories, 
                      Number_of_Full_Time_Employees, Number_of_Part_Time_Employees, Number_of_Temporary_Employees, Number_of_Total_Employees, 
                      Number_of_Lease_Employees, Number_of_Rooms, Number_of_Years_in_Operation, Other_Assurance_Percent, Percentage_Occupancy, 
                      Personal_Financial_Planning_Percent, Plan_Assets, Review_Percent, SEC_Work_Percent, Total_Claims, Total_Participants, Turnover_Rate, Year_Condo_Built, 
                      Year_Roof_Updated, Claims_Past_5yrs_Range, Employee_Salary_GT100k_Range, Insider_Shareholder_Percent_Range, Employees_SUM_Range, 
                      Number_of_Full_Time_Employees_Range, Number_of_Part_Time_Employees_Range, Number_of_Temporary_Employees_Range, 
                      ...
                      Number_of_Swimming_Pools, Number_of_Swimming_Pools_Range
