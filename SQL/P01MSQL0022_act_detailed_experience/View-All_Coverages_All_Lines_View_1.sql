IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[All_Coverages_All_Lines_View_1]'))
DROP VIEW [dbo].[All_Coverages_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[All_Coverages_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.All_Coverages_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_February.Clubs_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_February.Driving_Range_Avg_Rate_Range, 
                      ...
                      dbo.Latest_All_Lines_View_1.County_Pop_Density_Range, dbo.Policy_Information_FF_February.TrimBusiness_Type, 
                      dbo.Policy_Information_FF_February.FF_EPL_Num_of_Employees_Range, dbo.Policy_Information_FF_February.FF_EPL_Limit, 
                      dbo.Policy_Information_FF_February.FF_DO_Limit, dbo.Policy_Information_FF_February.FF_DO_Alt_Retention_int, 
                      dbo.Policy_Information_FF_February.FF_EPL_Alt_Retention_int, dbo.Policy_Information_FF_February.FF_EPL_Limit_int, 
...
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      dbo.Policy_Information_FF_February ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_FF_February.policynumber LEFT OUTER JOIN
...
WHERE     (dbo.Latest_All_Lines_View_1.statecode = ''NM'') AND (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2007)
' 
GO
