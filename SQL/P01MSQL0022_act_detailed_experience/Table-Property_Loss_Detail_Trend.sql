IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Property_Loss_Detail_Trend]') AND type in (N'U'))
DROP TABLE [dbo].[Property_Loss_Detail_Trend]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Property_Loss_Detail_Trend]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Property_Loss_Detail_Trend](
