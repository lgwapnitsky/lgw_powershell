IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_AL_All_Lines_View_1]'))
DROP VIEW [dbo].[State_AL_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_AL_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_AL_All_Lines_View_1
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_April.statecode, dbo.ALL_POLICIES_12_premium_summary_April.Coverage_Reporting_group, 
                      ...
                      AS Reported_Claims, SUM(dbo.ALL_POLICIES_12_premium_summary_April.COL_GLBI_Malpractice_Count) AS COL_GLBI_Malpractice_Count, 
                      ...
                      SUM(dbo.ALL_POLICIES_12_premium_summary_April.COL_GLBI_Sexual_Assault_Molest_Abuse_Count) 
                      AS COL_GLBI_Sexual_Assault_Molest_Abuse_Count, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_April.COL_GLBI_Sexual_Assault_Molest_Abuse_Loss) 
                      AS COL_GLBI_Sexual_Assault_Molest_Abuse_Loss, SUM(dbo.ALL_POLICIES_12_premium_summary_April.COL_GLBI_PropertyDamage_Loss) 
                      AS COL_GLBI_PropertyDamage_Loss, SUM(dbo.ALL_POLICIES_12_premium_summary_April.COL_GLBI_PropertyDamage_Count) 
                      AS COL_GLBI_PropertyDamage_Count, SUM(dbo.ALL_POLICIES_12_premium_summary_April.COL_GLBI_Theft_Loss) AS COL_GLBI_Theft_Loss, 
                      ...
                      SUM(dbo.ALL_POLICIES_12_premium_summary_April.COL_GLBI_Discrim_WrongfulTermination_Loss) 
                      AS COL_GLBI_Discrim_WrongfulTermination_Loss, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_April.COL_GLBI_Discrim_WrongfulTermination_Count) 
                      AS COL_GLBI_Discrim_WrongfulTermination_Count, SUM(dbo.ALL_POLICIES_12_premium_summary_April.Incurred_Claims) AS Incurred_Claims, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_April.FA_Constr_Code_Dominant_NAME, 
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_April.FA_Hail_Dominant, 
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_April.ZIP_Pop_Density_Dominant, 
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_April.FA_Avg_Bld_Rate_Range, 
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_April.FA_Avg_Bld_Rate_rd2, dbo.Policy_Information_ALL_POLICIES_FireAllied_April.FA_Deductible, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_April.COL_Prop_Wind_Hail_Count) AS COL_Prop_Wind_Hail_Count, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_April.COL_Prop_Wind_Hail_Loss) AS COL_Prop_Wind_Hail_Loss, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_AUTO_April.Auto_Vehicle_count_Dual_Control_Percent_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_April.Hired_Auto, dbo.Policy_Information_ALL_POLICIES_AUTO_April.Non_Owned_Auto, 
                      dbo.Policy_Information_GL_AVG_RATES_April.Churches_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_April.Day_Care_Avg_Rate_Range,
                       dbo.Policy_Information_ALL_POLICIES_April.Primary_Producer_code, 
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_April.Last_Reporting_Month, dbo.Policy_Information_ALL_POLICIES_April.PIC_Producer, 
                      dbo.Policy_Information_ALL_POLICIES_April.First_Policy_Year, dbo.Policy_Information_ALL_POLICIES_April.underwriter, 
                      dbo.Policy_Information_ALL_POLICIES_April.BusinessClassDesc, dbo.Policy_Information_ALL_POLICIES_April.Source_Detail_Name
FROM         dbo.ALL_POLICIES_12_premium_summary_April LEFT OUTER JOIN
                      AccessPhlyEom.dbo.product ON 
                      dbo.ALL_POLICIES_12_premium_summary_April.productcode = AccessPhlyEom.dbo.product.productcode LEFT OUTER JOIN
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_April.statecode, dbo.ALL_POLICIES_12_premium_summary_April.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_April.First_Policy_Year, dbo.Policy_Information_ALL_POLICIES_April.underwriter, 
                      dbo.Policy_Information_ALL_POLICIES_April.BusinessClassDesc, dbo.Policy_Information_ALL_POLICIES_April.Source_Detail_Name
HAVING      (dbo.ALL_POLICIES_12_premium_summary_April.statecode = ''AL'')
' 
GO
