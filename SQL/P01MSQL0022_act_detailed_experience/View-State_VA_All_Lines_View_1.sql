IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_VA_All_Lines_View_1]'))
DROP VIEW [dbo].[State_VA_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_VA_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_VA_All_Lines_View_1
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_April.statecode, dbo.ALL_POLICIES_12_premium_summary_April.Coverage_Reporting_group, 
                      ...
                      AccessPHLYEOM.dbo.product.producttype, dbo.ALL_POLICIES_12_premium_summary_April.Last_Reporting_Year, 
                      dbo.ALL_POLICIES_12_premium_summary_April.Last_Reporting_Month, dbo.ALL_POLICIES_12_premium_summary_April.Fiscal_AY_Month_Ending
FROM         AccessPHLYEOM.dbo.Division RIGHT OUTER JOIN
                      ...
                      AccessPHLYEOM.dbo.product.productcode = dbo.ALL_POLICIES_12_premium_summary_April.productcode LEFT OUTER JOIN
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_April.statecode, dbo.ALL_POLICIES_12_premium_summary_April.Coverage_Reporting_group, 
                      ...
                      AccessPHLYEOM.dbo.product.producttype, dbo.ALL_POLICIES_12_premium_summary_April.Last_Reporting_Year, 
                      dbo.ALL_POLICIES_12_premium_summary_April.Last_Reporting_Month, dbo.ALL_POLICIES_12_premium_summary_April.Fiscal_AY_Month_Ending
HAVING      (AccessPHLYEOM.dbo.product.producttype <> ''U'') AND (dbo.ALL_POLICIES_12_premium_summary_April.statecode = ''VA'') AND 
                      (dbo.ALL_POLICIES_12_premium_summary_April.Fiscal_AY_Year > 2006)
' 
GO
