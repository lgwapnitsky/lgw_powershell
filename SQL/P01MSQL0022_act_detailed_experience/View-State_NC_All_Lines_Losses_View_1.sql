IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_NC_All_Lines_Losses_View_1]'))
DROP VIEW [dbo].[State_NC_All_Lines_Losses_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_NC_All_Lines_Losses_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_NC_All_Lines_Losses_View_1
AS
SELECT     dbo.ALL_POLICIES_12_Detail_Information_1_May.Accountnumber, dbo.ALL_POLICIES_12_Detail_Information_1_May.Policy_Number, 
                      ...
                      dbo.ALL_POLICIES_12_Detail_Information_1_May.Premium_State, dbo.ALL_POLICIES_12_Detail_Information_1_May.Accident_State_for_join
...
WHERE     (dbo.ALL_POLICIES_12_Detail_Information_1_May.Premium_State = ''NC'')
' 
GO
