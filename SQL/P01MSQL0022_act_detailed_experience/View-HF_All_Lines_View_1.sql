IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[HF_All_Lines_View_1]'))
DROP VIEW [dbo].[HF_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[HF_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.HF_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Health_Exercise_Club_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Health_Exercise_Club_Avg_Rate, 
                      dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Swimming_Pools_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Swimming_Pools_Avg_Rate, Act_Definitions.dbo.State_Group_Products.State_Group_HF, 
                      ...
                      dbo.Latest_All_Lines_View_1.PrimaryProducerNumber
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      Act_Definitions.dbo.State_Group_Products ON dbo.Latest_All_Lines_View_1.statecode = Act_Definitions.dbo.State_Group_Products.State_Code LEFT OUTER JOIN
                      dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1 ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Policynumber LEFT OUTER JOIN
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_LATEST_View_1 ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_ALL_POLICIES_FireAllied_LATEST_View_1.policynumber
WHERE     (dbo.Latest_All_Lines_View_1.productcode = ''HF'') AND (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2008) AND 
                      (dbo.Latest_All_Lines_View_1.PrimaryProducerNumber = 106135)
' 
GO
