IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_Step_22b_Non_Hired_Non_Owned]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_Step_22b_Non_Hired_Non_Owned]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_Step_22b_Non_Hired_Non_Owned]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'
CREATE procedure [dbo].[usp_Step_22b_Non_Hired_Non_Owned] as  

-- FootPrints Ticket #73460
-- Creator:	Steve Breisch
-- Date: 6/11/2013
-- Description: Step 2 of the Non Hired Non Owned Process
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N''[dbo].[ALL_POLICIES_12_Detail_Information_1_non_hired_non_owned_work]'') AND type in (N''U''))
Drop Table Act_Detailed_Experience.dbo.ALL_POLICIES_12_Detail_Information_1_non_hired_non_owned_work

CREATE TABLE [Act_Detailed_Experience].[dbo].[ALL_POLICIES_12_Detail_Information_1_non_hired_non_owned_work](
...
Set @Loss_Evaluation_Month = (select Loss_Evaluation_Month from Detailed_Experience_Parameters)		

Declare @Loss_Evaluation_Year as float
Set @Loss_Evaluation_Year = (select Loss_Evaluation_Year from Detailed_Experience_Parameters)	

insert into Act_Detailed_Experience.dbo.ALL_POLICIES_12_Detail_Information_1_non_hired_non_owned_work
(	company ,
	Accountnumber ,
	Policy_Number ,
	Claim_Number ,
...
COL_AE_Breach_of_Contract as COL_AE_Breach_of_Contract_Count,
	 ...
	 COL_CL_Breach_of_Contract as COL_CL_Breach_of_Contract_Count,
		...
		then 0.0 else COL_CL_Violation_GAAP end) as COL_CL_Negligent_Training_Count,
		...
		then 0.0 else COL_CL_Violation_GAAP end) as COL_CL_Electronic_Data_Damage_Count,
...
(Case When COL_AUTO_PHYS_Theft > 0 then Incurred_Loss_ALAE_with_SS_Noncat else 0.0 end) as COL_AUTO_PHYS_Theft_Loss,
	...
	(case
		when coverage_group in (''GL'',''Professional'') 
...
update Act_Detailed_Experience.dbo.ALL_POLICIES_12_Detail_Information_1_non_hired_non_owned_work
set 
Latest_Claim_Trans_Yr_Mm = LCT.Latest_Claim_Trans_Yr_Mm
from Act_Detailed_Experience.dbo.ALL_POLICIES_12_Detail_Information_1_non_hired_non_owned_work LD
...
from Act_Detailed_Experience.dbo.ALL_POLICIES_12_Detail_Information_1_non_hired_non_owned_work LCT
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N''[dbo].[ALL_POLICIES_12_Detail_Information_2_non_hired_non_owned_work]'') AND type in (N''U''))
Drop Table Act_Detailed_Experience.dbo.ALL_POLICIES_12_Detail_Information_2_non_hired_non_owned_work

CREATE TABLE [Act_Detailed_Experience].[dbo].[ALL_POLICIES_12_Detail_Information_2_non_hired_non_owned_work](
	[Accountnumber] [int],
...
insert into Act_Detailed_Experience.dbo.ALL_POLICIES_12_Detail_Information_2_non_hired_non_owned_work
(	Accountnumber ,
	PolicyNumber ,
	Experienceproduct  ,
	Productcode  ,
...
update Act_Detailed_Experience.dbo.ALL_POLICIES_12_Detail_Information_2_non_hired_non_owned_work
set 
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N''[dbo].[ALL_POLICIES_12_Detail_Information_3_non_hired_non_owned_work]'') AND type in (N''U''))
Drop Table Act_Detailed_Experience.dbo.ALL_POLICIES_12_Detail_Information_3_non_hired_non_owned_work
	
CREATE TABLE [Act_Detailed_Experience].[dbo].[ALL_POLICIES_12_Detail_Information_3_non_hired_non_owned_work](
	[Accountnumber] [int],
	[PolicyNumber] [varchar](15) COLLATE SQL_Latin1_General_CP1_CI_AS,
	[Experienceproduct] [varchar] (5) COLLATE SQL_Latin1_General_CP1_CI_AS,
	[Productcode] [varchar] (2) COLLATE SQL_Latin1_General_CP1_CI_AS,
...
insert into Act_Detailed_Experience.dbo.ALL_POLICIES_12_Detail_Information_3_non_hired_non_owned_work
Select
