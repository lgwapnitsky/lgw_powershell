IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Umbrella_Credibility_2013_02]') AND type in (N'U'))
DROP TABLE [dbo].[Umbrella_Credibility_2013_02]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Umbrella_Credibility_2013_02]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Umbrella_Credibility_2013_02](
