IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[EK_All_Lines_View_1]'))
DROP VIEW [dbo].[EK_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[EK_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.EK_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_May.Clubs_Avg_Rate_Range, dbo.Policy_Information_Underwriting_Check_List_May.Liquor_Liability_YN, 
                      dbo.Policy_Information_GL_AVG_RATES_May.Swimming_Pools_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_May.Amusement_Centers_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_May.Amusement_Parks_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_May.Athletic_Programs_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_May.Concessionaires_Avg_Rate_Range,
                       dbo.Policy_Information_GL_AVG_RATES_May.Exhibition_Bldgs_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_May.Exhibitions_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_May.Indoor_play_centers_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_May.Race_Tracks_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_May.Stadiums_Avg_Rate_Range, dbo.Latest_All_Lines_View_1.CompanyCode, dbo.Latest_All_Lines_View_1.programdesc, 
                      dbo.Latest_All_Lines_View_1.PICProducer, dbo.Latest_All_Lines_View_1.PrimaryProducerType, dbo.Latest_All_Lines_View_1.Account_Premium_Range, 
                      dbo.Latest_All_Lines_View_1.PrimaryProducer
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_May ON dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_GL_AVG_RATES_May.Policynumber
WHERE     (dbo.Latest_All_Lines_View_1.productcode = ''EK'') AND (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2008)
' 
GO
