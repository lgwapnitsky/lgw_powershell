IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[All_Policies_ALL_LOB_12mon_tiein_View_January]'))
DROP VIEW [dbo].[All_Policies_ALL_LOB_12mon_tiein_View_January]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[All_Policies_ALL_LOB_12mon_tiein_View_January]'))
...
CREATE VIEW [dbo].[All_Policies_ALL_LOB_12mon_tiein_View_January]
AS
...
FROM         dbo.ALL_POLICIES_12_premium_summary_January
