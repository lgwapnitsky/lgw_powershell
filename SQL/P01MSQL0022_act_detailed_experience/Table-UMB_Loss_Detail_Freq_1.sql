IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UMB_Loss_Detail_Freq_1]') AND type in (N'U'))
DROP TABLE [dbo].[UMB_Loss_Detail_Freq_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UMB_Loss_Detail_Freq_1]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[UMB_Loss_Detail_Freq_1](
