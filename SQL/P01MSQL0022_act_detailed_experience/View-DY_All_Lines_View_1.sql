IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[DY_All_Lines_View_1]'))
DROP VIEW [dbo].[DY_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[DY_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.DY_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Day_Care_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Day_Care_Avg_Rate, dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Day_Care_FP_Avg_Rate, 
                      dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Day_Care_FP_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Day_Care_NP_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Day_Care_NP_Avg_Rate, dbo.Latest_All_Lines_View_1.programdesc, 
                      ...
                      dbo.Latest_All_Lines_View_1.Account_Premium_Range, dbo.Latest_All_Lines_View_1.PrimaryProducerNumber
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1 ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Policynumber
WHERE     (dbo.Latest_All_Lines_View_1.productcode = ''DY'') AND (dbo.Latest_All_Lines_View_1.PrimaryProducerNumber = 20066)
' 
GO
