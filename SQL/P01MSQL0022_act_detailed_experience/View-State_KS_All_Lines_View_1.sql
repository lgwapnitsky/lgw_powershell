IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_KS_All_Lines_View_1]'))
DROP VIEW [dbo].[State_KS_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_KS_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_KS_All_Lines_View_1
AS
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_January.statecode, dbo.ALL_POLICIES_12_premium_summary_January.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_January.First_Policy_Year, dbo.Policy_Information_ALL_POLICIES_January.underwriter, 
                      dbo.Policy_Information_ALL_POLICIES_January.BusinessClassDesc, dbo.Policy_Information_ALL_POLICIES_January.Source_Detail_Name
HAVING      (dbo.ALL_POLICIES_12_premium_summary_January.statecode = ''ks'')
' 
GO
