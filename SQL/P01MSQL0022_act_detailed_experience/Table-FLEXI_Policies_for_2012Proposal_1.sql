IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[FLEXI_Policies_for_2012Proposal_1]') AND type in (N'U'))
DROP TABLE [dbo].[FLEXI_Policies_for_2012Proposal_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[FLEXI_Policies_for_2012Proposal_1]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[FLEXI_Policies_for_2012Proposal_1](
	...
	[Prop(Current)BaseRate] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Prop(PV)BaseRate] [float] NULL,
	[FinalPremium] [float] NULL,
	[ImplPrem] [float] NULL,
	[OnFilePrem] [float] NULL,
	[PropPrem(Current)] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[Proposed(Curr) w/o JM] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Proposed(PV) w/o JM] [float] NULL,
	[JM Dollars] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[JM Dollars (PV)] [float] NULL,
	[SchedMod] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[MiscMod] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[EmployeeBands] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Terr] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[AccountLossRatioCHECK] [float] NULL,
	[AccountLossRatioRangeCHECK] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
END
GO
