IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GC_premium_summary]') AND type in (N'U'))
DROP TABLE [dbo].[GC_premium_summary]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GC_premium_summary]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[GC_premium_summary](
