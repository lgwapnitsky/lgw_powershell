IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[CO_All_Lines_View_1]'))
DROP VIEW [dbo].[CO_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[CO_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.CO_All_Lines_View_1
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_B.statecode, dbo.ALL_POLICIES_12_premium_summary_B.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_B.Endorsement_Elite_YN, dbo.Policy_Information_GL_AVG_RATES_B.Clubs_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_B.Swimming_Pools_Avg_Rate_Range, 
                      dbo.Policy_Information_Underwriting_Check_List_B.Year_Roof_Updated_Range, 
                      dbo.Policy_Information_Underwriting_Check_List_B.Year_Built_Range, 
                      dbo.Policy_Information_Underwriting_Check_List_B.Number_of_Buildings_Greater_than_3_Stories_Range
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_B.statecode, dbo.ALL_POLICIES_12_premium_summary_B.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_Underwriting_Check_List_B.Year_Built_Range, 
                      dbo.Policy_Information_Underwriting_Check_List_B.Number_of_Buildings_Greater_than_3_Stories_Range
HAVING      (dbo.Policy_Information_ALL_POLICIES_B.Primary_Umbrella = ''Primary'') AND (dbo.ALL_POLICIES_12_premium_summary_B.productcode = ''CO'')
' 
GO
