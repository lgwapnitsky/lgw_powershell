IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_NC_All_Lines_View_2]'))
DROP VIEW [dbo].[State_NC_All_Lines_View_2]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_NC_All_Lines_View_2]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW [dbo].[State_NC_All_Lines_View_2]
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_June.statecode, dbo.ALL_POLICIES_12_premium_summary_June.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_June.Churches_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_June.Day_Care_Avg_Rate_Range, dbo.Policy_Information_ALL_POLICIES_June.Primary_Producer_code, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_RepLoss_Ratio_NonCat_Working_Cover_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_UltLoss_Ratio_NonCat_Working_Cover_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_UltLoss_Ratio_Working_Cover_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_RepLoss_Ratio_Working_Cover_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_RepLoss_Ratio_NonCat_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_UltLoss_Ratio_NonCat_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_RepLoss_Ratio_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_UltLoss_Ratio_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_RepLoss_Ratio_NonCat_Range, 
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_June.Fiscal_AY_Month_Ending, dbo.ALL_POLICIES_12_premium_summary_June.Last_Reporting_Year, 
                      dbo.ALL_POLICIES_12_premium_summary_June.Last_Reporting_Month, dbo.Policy_Information_ALL_POLICIES_June.PIC_Producer, 
                      dbo.Policy_Information_ALL_POLICIES_June.First_Policy_Year, dbo.Policy_Information_ALL_POLICIES_June.underwriter, 
                      dbo.Policy_Information_ALL_POLICIES_June.BusinessClassDesc, dbo.Policy_Information_ALL_POLICIES_June.Source_Detail_Name
FROM         dbo.ALL_POLICIES_12_premium_summary_June LEFT OUTER JOIN
                      AccessPhlyEom.dbo.product ON 
                      dbo.ALL_POLICIES_12_premium_summary_June.productcode = AccessPhlyEom.dbo.product.productcode LEFT OUTER JOIN
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_June.statecode, dbo.ALL_POLICIES_12_premium_summary_June.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_June.First_Policy_Year, dbo.Policy_Information_ALL_POLICIES_June.underwriter, 
                      dbo.Policy_Information_ALL_POLICIES_June.BusinessClassDesc, dbo.Policy_Information_ALL_POLICIES_June.Source_Detail_Name
HAVING      (dbo.ALL_POLICIES_12_premium_summary_June.statecode = ''NC'')
' 
GO
