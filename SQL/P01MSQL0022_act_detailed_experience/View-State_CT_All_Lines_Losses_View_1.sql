IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_CT_All_Lines_Losses_View_1]'))
DROP VIEW [dbo].[State_CT_All_Lines_Losses_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_CT_All_Lines_Losses_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_CT_All_Lines_Losses_View_1
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_April.statecode, dbo.ALL_POLICIES_12_premium_summary_April.Coverage_Reporting_group, 
                      ...
                      SUM(dbo.ALL_POLICIES_12_premium_summary_April.Incurred_Loss_ALAE_with_SS_NonCat) AS Expr1, 
                      ...
                      AS Ult_LDF_Capped_Incurred_Loss_ALAE_with_SS_wo_cat, SUM(dbo.ALL_POLICIES_12_premium_summary_April.Reported_Claims) AS Expr2, 
                      ...
                      SUM(dbo.ALL_POLICIES_12_premium_summary_April.Incurred_Claims) AS Expr3, SUM(dbo.ALL_POLICIES_12_premium_summary_April.Commission_dollars) 
                      AS Commission_dollars, SUM(dbo.ALL_POLICIES_12_premium_summary_April.Commission_Premiums) AS Commission_Premiums, 
                      ...
                      SUM(dbo.ALL_POLICIES_12_premium_summary_April.Incurred_Loss_ALAE_with_SS) AS Expr4, 
                      ...
                      SUM(dbo.ALL_POLICIES_12_premium_summary_April.Incurred_Loss_ALAE_with_SS_CatOnly) AS Expr5, 
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_April.statecode, dbo.ALL_POLICIES_12_premium_summary_April.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_April.underwriter, dbo.Policy_Information_ALL_POLICIES_April.BusinessClassDesc, 
                      dbo.Policy_Information_ALL_POLICIES_April.Source_Detail_Name
HAVING      (dbo.ALL_POLICIES_12_premium_summary_April.statecode = ''CT'')
' 
GO
