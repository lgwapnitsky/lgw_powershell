IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GL_Class_Code_Avg_Rate_ALL_POLICIES_March]') AND type in (N'U'))
DROP TABLE [dbo].[GL_Class_Code_Avg_Rate_ALL_POLICIES_March]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GL_Class_Code_Avg_Rate_ALL_POLICIES_March]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[GL_Class_Code_Avg_Rate_ALL_POLICIES_March](
