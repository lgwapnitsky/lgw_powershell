IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ALL_POLICIES_15_Detail_Information_2_March]') AND type in (N'U'))
DROP TABLE [dbo].[ALL_POLICIES_15_Detail_Information_2_March]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ALL_POLICIES_15_Detail_Information_2_March]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[ALL_POLICIES_15_Detail_Information_2_March](
