IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[NPDO_ALL_Lines_View_1_EndRateDev]'))
DROP VIEW [dbo].[NPDO_ALL_Lines_View_1_EndRateDev]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[NPDO_ALL_Lines_View_1_EndRateDev]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.NPDO_ALL_Lines_View_1_EndRateDev
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_August.Clubs_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_August.Driving_Range_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_August.Golf_Municipal_Public_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_August.Golf_Club_Country_Club_Avg_Rate_Range, 
                      dbo.Policy_Information_Underwriting_Check_List_August.Liquor_Liability_YN, dbo.Policy_Information_GL_AVG_RATES_August.Swimming_Pools_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_August.Miniature_Golf_Avg_Rate_Range, dbo.Latest_All_Lines_View_1.CompanyCode, 
                      ...
                      dbo.Latest_All_Lines_View_1.COL_SLD_All_Other_Loss, dbo.Latest_All_Lines_View_1.County_Pop_Density_Range, 
                      dbo.Policy_Information_FF_August.FF_DO_RatingClass, dbo.Policy_Information_FF_August.TrimBusiness_Type, 
                      dbo.Policy_Information_FF_August.FF_EPL_RatingClass, dbo.Policy_Information_FF_August.FF_EPL_Num_of_Employees_Range, 
                      dbo.Policy_Information_FF_August.FF_EPL_Limit, dbo.Policy_Information_FF_August.FF_DO_Limit, dbo.Policy_Information_FF_August.FF_DO_Alt_Retention_int, 
                      dbo.Policy_Information_FF_August.FF_EPL_Alt_Retention_int, dbo.Policy_Information_FF_August.FF_EPL_Limit_int, dbo.Latest_All_Lines_View_1.Bylaws_YN, 
                      ...
                      dbo.Latest_All_Lines_View_1.PV_Cov_ALL, dbo.Latest_All_Lines_View_1.policyEffectivedate, dbo.Latest_All_Lines_View_1.policyexpirationdate, 
                      dbo.Latest_All_Lines_View_1.Account_ProductType_P, dbo.Policy_Information_FF_August.Endorsement_FlexiProPak, 
                      dbo.Policy_Information_FF_August.Endorsement_FlexiProPak_YN, dbo.Policy_Information_FF_August.Endorsement_AmendExclusion, 
                      dbo.Policy_Information_FF_August.Endorsement_AmendExclusion_YN, dbo.Policy_Information_FF_August.Endorsement_DefenseInLimit, 
                      dbo.Policy_Information_FF_August.Endorsement_DefenseInLimit_YN, dbo.Policy_Information_FF_August.Manuscript_FLSAWageHour_YN
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      dbo.Policy_Information_FF_August ON dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_FF_August.policynumber LEFT OUTER JOIN
                      dbo.Policy_Information_Underwriting_Check_List_August ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_Underwriting_Check_List_August.policynumber LEFT OUTER JOIN
                      dbo.Policy_Information_GL_AVG_RATES_August ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_GL_AVG_RATES_August.Policynumber
WHERE     (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2007) AND (dbo.Latest_All_Lines_View_1.productcode = ''ff'')
' 
GO
