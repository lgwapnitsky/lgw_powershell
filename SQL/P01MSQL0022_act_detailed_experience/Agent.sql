...
GO
EXEC master.dbo.xp_instance_regwrite N'HKEY_LOCAL_MACHINE', N'SOFTWARE\Microsoft\MSSQLServer\SQLServerAgent', N'DatabaseMailProfile', N'REG_SZ', N'phlysqldba'
GO
EXEC msdb.dbo.sp_set_sqlagent_properties @sqlserver_restart=1, 
		...
		@errorlog_file=N'F:\MSSQL10_50.MSSQLSERVER\MSSQL\Log\SQLAGENT.OUT', 
