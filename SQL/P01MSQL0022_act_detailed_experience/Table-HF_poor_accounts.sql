IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[HF_poor_accounts]') AND type in (N'U'))
DROP TABLE [dbo].[HF_poor_accounts]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[HF_poor_accounts]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[HF_poor_accounts](
	...
	[Auto_Vehicle_count_Total_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Auto_Vehicle_count_Truck_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Auto_Vehicle_count_PPT_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Auto_Vehicle_count_Buses_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Auto_Vehicle_count_VanPools_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Auto_Vehicle_count_OtherPublic_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Auto_Vehicle_count_Other_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[GL_Class_Health_Exercise_Club_Exposure] [float] NULL,
	[GL_Class_Health_Exercise_Club_RatingPrem] [float] NULL,
	[GL_Class_Health_Exercise_Club_Exposure_adj] [float] NULL,
	...
	[GL_Class_Health_Exercise_Club_AvgRate] [float] NULL,
	[GL_Class_Swimming_Pools_AvgRate] [float] NULL,
	[GL_Class_Health_Exercise_Club_AvgRate_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
