IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VS_forAngoss]'))
DROP VIEW [dbo].[VS_forAngoss]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[VS_forAngoss]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.VS_forAngoss
AS
