IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[CA_All_Lines_Losses_View_1]'))
DROP VIEW [dbo].[CA_All_Lines_Losses_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[CA_All_Lines_Losses_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.CA_All_Lines_Losses_View_1
AS
SELECT     dbo.ALL_POLICIES_12_Detail_Information_1_May.Accountnumber, dbo.ALL_POLICIES_12_Detail_Information_1_May.Policy_Number, 
                      ...
                      dbo.ALL_POLICIES_12_Detail_Information_1_May.Incurred_Loss_ALAE_with_SS_CatOnly, dbo.ALL_POLICIES_12_Detail_Information_1_May.Reported_Claims, 
                      dbo.ALL_POLICIES_12_Detail_Information_1_May.Open_Claims, dbo.ALL_POLICIES_12_Detail_Information_1_May.Closed_With_Pay_Claims, 
...
WHERE     (dbo.ALL_POLICIES_12_Detail_Information_1_May.Premium_State = ''cA'') AND (dbo.ALL_POLICIES_12_Detail_Information_1_May.Coverage_Reporting_group = ''gl'') 
                      AND (dbo.ALL_POLICIES_12_Detail_Information_1_May.Product <> ''%u'')
' 
GO
