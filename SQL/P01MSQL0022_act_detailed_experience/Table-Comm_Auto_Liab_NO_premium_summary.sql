IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Comm_Auto_Liab_NO_premium_summary]') AND type in (N'U'))
DROP TABLE [dbo].[Comm_Auto_Liab_NO_premium_summary]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Comm_Auto_Liab_NO_premium_summary]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Comm_Auto_Liab_NO_premium_summary](
	...
	[Auto_Liability_Limit] [float] NULL,
	[Auto_Liability_Deductible] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
