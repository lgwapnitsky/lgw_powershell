IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Inland_Marine_Filing_Loss_NewYork_20080902_2]') AND type in (N'U'))
DROP TABLE [dbo].[Inland_Marine_Filing_Loss_NewYork_20080902_2]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Inland_Marine_Filing_Loss_NewYork_20080902_2]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Inland_Marine_Filing_Loss_NewYork_20080902_2](
