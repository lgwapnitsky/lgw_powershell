IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Policy_Information_FF_August]') AND type in (N'U'))
DROP TABLE [dbo].[Policy_Information_FF_August]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Policy_Information_FF_August]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Policy_Information_FF_August](
	...
	[Endorsement_FlexiProPak] [varchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Endorsement_FlexiProPak_YN] [varchar](1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Endorsement_AmendExclusion] [varchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Endorsement_AmendExclusion_YN] [varchar](1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Endorsement_DefenseInLimit] [varchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Endorsement_DefenseInLimit_YN] [varchar](1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Manuscript_FLSAWageHour_YN] [varchar](1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
END
GO
