IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_AL_Lines_Losses_View_1]'))
DROP VIEW [dbo].[State_AL_Lines_Losses_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_AL_Lines_Losses_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_AL_Lines_Losses_View_1
AS
SELECT     dbo.ALL_POLICIES_12_Detail_Information_1_April.Accountnumber, dbo.ALL_POLICIES_12_Detail_Information_1_April.Policy_Number, 
                      ...
                      dbo.ALL_POLICIES_12_Detail_Information_1_April.Incurred_Loss_ALAE_with_SS_CatOnly, 
                      dbo.ALL_POLICIES_12_Detail_Information_1_April.Reported_Claims, dbo.ALL_POLICIES_12_Detail_Information_1_April.Open_Claims, 
                      dbo.ALL_POLICIES_12_Detail_Information_1_April.Closed_With_Pay_Claims, 
                      ...
                      dbo.ALL_POLICIES_12_Detail_Information_1_April.Premium_State, dbo.Policy_Information_ALL_POLICIES_April.BusinessClassDesc, 
                      dbo.Policy_Information_ALL_POLICIES_April.DivisionName, dbo.Policy_Information_ALL_POLICIES_April.ProductType
...
WHERE     (dbo.ALL_POLICIES_12_Detail_Information_1_April.Premium_State = ''AL'')
' 
GO
