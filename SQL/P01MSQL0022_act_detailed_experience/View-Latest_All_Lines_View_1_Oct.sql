IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_All_Lines_View_1_Oct]'))
DROP VIEW [dbo].[Latest_All_Lines_View_1_Oct]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_All_Lines_View_1_Oct]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.Latest_All_Lines_View_1_Oct
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_October.statecode, dbo.ALL_POLICIES_12_premium_summary_October.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_October.Branch_Region, dbo.ALL_POLICIES_12_premium_summary_October.Coverage_Group, 
                      dbo.Policy_Information_ALL_POLICIES_October.Primary_Umbrella, SUM(dbo.ALL_POLICIES_12_premium_summary_October.Earned_Buildings) 
                      AS Earned_Buildings, SUM(dbo.ALL_POLICIES_12_premium_summary_October.Earned_Locations) AS Earned_Locations, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_October.Primary_Producer_type, dbo.Policy_Information_Underwriting_Check_List_October.Playground_YN, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_October.Endorsement_Elite_YN, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_AUTO_October.Auto_Vehicle_count_Coll_No_Ded_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_October.Auto_Vehicle_count_Coll_U1000_Ded_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_October.Auto_Vehicle_count_Coll_1000_Ded_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_October.Auto_Vehicle_count_Coll_O1000_Ded_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_October.Auto_Vehicle_count_OTC_No_Ded_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_October.Auto_Vehicle_count_OTC_U1000_Ded_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_October.Auto_Vehicle_count_OTC_1000_Ded_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_October.Auto_Vehicle_count_OTC_O1000_Ded_Range, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_October.First_Policy_Year, dbo.Policy_Information_ALL_POLICIES_October.PIC_Producer, 
                      dbo.Policy_Information_ALL_POLICIES_October.underwriter, dbo.ALL_POLICIES_12_premium_summary_October.Fiscal_AY_Month_Ending, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_October.Account_UltLoss_Ratio, 
                      dbo.Policy_Information_ALL_POLICIES_October.Account_UltLoss_Ratio_NonCat, 
                      dbo.Policy_Information_ALL_POLICIES_October.Account_RepLoss_Ratio, 
                      dbo.Policy_Information_ALL_POLICIES_October.Account_RepLoss_Ratio_NonCat, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_October.Renewals_Range, dbo.Policy_Information_ALL_POLICIES_October.Branch_Office, 
                      dbo.Policy_Information_ALL_POLICIES_October.Endorsement_HS_004, Act_Pricing.dbo.DNB_Mar2011_Final.CSCORE_GMODEL8, 
                      ...
                      dbo.Policy_PATHID_Information.accountname, dbo.Policy_Information_ALL_POLICIES_October.Account_Name, 
                      ...
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.Incurred_Loss_ALAE_without_SS_NonCat) AS Incurred_Loss_ALAE_without_SS_NonCat, 
                      dbo.ALL_POLICIES_12_premium_summary_October.accountnumber, dbo.Policy_Information_ALL_POLICIES_October.Source_Detail_Name, 
                      dbo.Policy_Information_ALL_POLICIES_October.BusinessClassDesc, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Breach_of_Contract_Count, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Breach_of_Contract_Loss, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Discrimination_Count, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Discrimination_Loss, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Wrongful_Termination_Count, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Wrongful_Termination_Loss, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Harrassment_Count, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Harrassment_Loss, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_DO_Other_Count, dbo.ALL_POLICIES_12_premium_summary_October.COL_DO_Other_Loss, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_EPL_Other_Count, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_EPL_Other_Loss, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Fiduciary_Other_Count, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Fiduciary_Other_Loss, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Worplace_Violence_Other_Count, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Worplace_Violence_Other_Loss, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_SLD_All_Other_Count, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_SLD_All_Other_Loss, 
                      dbo.Policy_Information_ALL_POLICIES_October.County_Pop_Density_Range, dbo.Policy_Information_Underwriting_Check_List_October.Bylaws_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Clean_Warranty_Letter_Received_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Disciplinary_Administrative_or_Criminal_Actions_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Disciplinary_Action_from_Peer_Review_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Employment_Application_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Employment_Handbook_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Employment_Application_Handbook_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Financials_YN, dbo.Policy_Information_Underwriting_Check_List_October.Form_5500_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Information_Only_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.List_of_D_and_Os_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Standard_Setting_or_Member_Certification_Services_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Merger_Acquisition_or_Consolidation_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.No_Loss_Letter_Received_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.No_Prior_Coverage_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Magazines_Periodicals_or_Newsletters_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Product_Research_or_Development_Testing_Certif_Services_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Proper_Employment_Procedures_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Peer_Review_or_Disciplinary_Action_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Positive_Fund_Balance_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Plan_Assets_Range, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Supplemental_Claim_Form_Loss_Run_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Security_Precautions_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Subsidiaries_Affiliates_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Supp_Claim_Form_Received_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Turnover_Rate_Range, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Tax_Exempt_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Transaction_E_Commerce_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Website_Information_Only_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Website_Transactional_E_Commerce_YN, 
                      dbo.ALL_POLICIES_12_premium_summary_October.acctngyear, dbo.Policy_PATHID_Information.FF_Cov_ALL, 
...
FROM         dbo.Policy_PATHID_Information RIGHT OUTER JOIN
                      ...
                      dbo.Policy_PATHID_Information.policynumber = dbo.Policy_Information_ALL_POLICIES_October.policynumber LEFT OUTER JOIN
                      Act_Pricing.dbo.DNB_Mar2011_Final ON 
                      dbo.Policy_Information_ALL_POLICIES_October.accountnumber = Act_Pricing.dbo.DNB_Mar2011_Final.ACCOUNT_NUMBER AND 
                      dbo.Policy_Information_ALL_POLICIES_October.policy_effective_year = Act_Pricing.dbo.DNB_Mar2011_Final.POLICY_YEAR RIGHT OUTER JOIN
                      dbo.ALL_POLICIES_12_premium_summary_October LEFT OUTER JOIN
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_October.policynumber = dbo.Policy_Information_ALL_POLICIES_FireAllied_October.policynumber ON 
                      dbo.Policy_Information_ALL_POLICIES_October.policynumber = dbo.ALL_POLICIES_12_premium_summary_October.policynumber LEFT OUTER JOIN
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_October.statecode, dbo.ALL_POLICIES_12_premium_summary_October.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_October.New_Renew_Tail, dbo.Policy_Information_ALL_POLICIES_October.Renew_New_Auto, 
                      dbo.Policy_Information_ALL_POLICIES_October.Branch_Region, dbo.ALL_POLICIES_12_premium_summary_October.Coverage_Group, 
                      dbo.Policy_Information_ALL_POLICIES_October.Primary_Umbrella, 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_October.GL_Dom_Terr_Description, 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_October.GL_Dom_Region_in_State, 
                      dbo.Policy_Information_ALL_POLICIES_October.Primary_Producer, 
                      dbo.Policy_Information_ALL_POLICIES_October.Account_UltLoss_Ratio_Working_Cover_Range, 
                      ...
                      dbo.Policy_PATHID_Information.producttype, dbo.Policy_PATHID_Information.PrimaryProducerNumber, dbo.Policy_PATHID_Information.effectivedate, 
                      dbo.Policy_PATHID_Information.expirationdate, dbo.Policy_PATHID_Information.Insured_Years_Range, 
                      dbo.Policy_PATHID_Information.SLD_BusinessType, dbo.ALL_POLICIES_12_premium_summary_October.accountnumber, 
                      dbo.Policy_Information_ALL_POLICIES_October.Source_Detail_Name, dbo.Policy_Information_ALL_POLICIES_October.BusinessClassDesc, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Breach_of_Contract_Count, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Breach_of_Contract_Loss, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Discrimination_Count, 
                      dbo.ALL_POLICIES_12_premium_summary_October.COL_Discrimination_Loss, 
