IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Auto_Liability_All_Lines_View_1]'))
DROP VIEW [dbo].[Auto_Liability_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Auto_Liability_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.Auto_Liability_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_February.Clubs_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_February.Driving_Range_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_February.Golf_Municipal_Public_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_February.Golf_Club_Country_Club_Avg_Rate_Range, 
                      dbo.Policy_Information_Underwriting_Check_List_February.Liquor_Liability_YN, 
                      dbo.Policy_Information_GL_AVG_RATES_February.Swimming_Pools_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_February.Miniature_Golf_Avg_Rate_Range, dbo.Latest_All_Lines_View_1.CompanyCode, 
                      ...
                      dbo.Policy_Information_FF_February.TrimBusiness_Type, dbo.Policy_Information_FF_February.FF_EPL_Num_of_Employees_Range, 
                      dbo.Policy_Information_FF_February.FF_EPL_Limit, dbo.Policy_Information_FF_February.FF_DO_Limit, 
                      dbo.Policy_Information_FF_February.FF_DO_Alt_Retention_int, dbo.Policy_Information_FF_February.FF_EPL_Alt_Retention_int, 
                      dbo.Policy_Information_FF_February.FF_EPL_Limit_int, dbo.Latest_All_Lines_View_1.Bylaws_YN, 
                      ...
                      dbo.Latest_All_Lines_View_1.PV_Cov_ALL, dbo.Policy_Information_FF_February.DF_RatingClass, dbo.Policy_Information_FF_February.DF_Limit, 
                      dbo.Policy_Information_FF_February.DF_Base_Retention, dbo.Policy_Information_FF_February.DF_Alt_Retention, 
                      dbo.Latest_All_Lines_View_1.PrimaryProducerNumber
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      dbo.Policy_Information_FF_February ON dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_FF_February.policynumber LEFT OUTER JOIN
                      dbo.Policy_Information_Underwriting_Check_List_February ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_Underwriting_Check_List_February.policynumber LEFT OUTER JOIN
                      dbo.Policy_Information_GL_AVG_RATES_February ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_GL_AVG_RATES_February.Policynumber
WHERE     (dbo.Latest_All_Lines_View_1.statecode IN (''PA'', ''KY'')) AND (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2007) AND 
                      (dbo.Latest_All_Lines_View_1.Coverage_Reporting_group IN (''auto liability'', ''auto phys dam''))
' 
GO
