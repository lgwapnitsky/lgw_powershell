IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[GC_All_Lines_View_1]'))
DROP VIEW [dbo].[GC_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[GC_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.GC_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_June.Clubs_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_June.Driving_Range_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_June.Golf_Municipal_Public_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_June.Golf_Club_Country_Club_Avg_Rate_Range, 
                      dbo.Policy_Information_Underwriting_Check_List_June.Liquor_Liability_YN, 
                      dbo.Policy_Information_GL_AVG_RATES_June.Swimming_Pools_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_June.Miniature_Golf_Avg_Rate_Range, dbo.Latest_All_Lines_View_1.CompanyCode, 
                      ...
                      dbo.Latest_All_Lines_View_1.PrimaryProducerType, dbo.Latest_All_Lines_View_1.Account_Premium_Range, 
                      dbo.Latest_All_Lines_View_1.effectiveYearMonth, dbo.Latest_All_Lines_View_1.effectiveYear, dbo.Latest_All_Lines_View_1.effectiveMonth, 
                      dbo.Latest_All_Lines_View_1.expirationMonth, dbo.Latest_All_Lines_View_1.expirationYear, dbo.Latest_All_Lines_View_1.expirationYearMonth, 
                      dbo.Latest_All_Lines_View_1.effectivedate, dbo.Latest_All_Lines_View_1.expirationdate
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      dbo.Policy_Information_Underwriting_Check_List_June ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_Underwriting_Check_List_June.policynumber LEFT OUTER JOIN
                      dbo.Policy_Information_GL_AVG_RATES_June ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_GL_AVG_RATES_June.Policynumber
WHERE     (dbo.Latest_All_Lines_View_1.productcode = ''GC'')
' 
GO
