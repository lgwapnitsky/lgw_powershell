IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[GO_All_Lines_View_1]'))
DROP VIEW [dbo].[GO_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[GO_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.GO_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Latest_All_Lines_View_1.Number_of_Renewals, dbo.Latest_All_Lines_View_1.Renewals_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_October.Sales_Service_Orgs_Avg_Rate_Range, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_October.Sales_Service_Orgs_Exposure, dbo.Policy_Information_GL_AVG_RATES_October.Sales_Service_Orgs_Premium, 
                      dbo.Policy_Information_GL_AVG_RATES_October.Sales_Service_Orgs_Class_Group, dbo.Policy_Information_GL_AVG_RATES_October.HomeHealthCare_Premium, 
                      dbo.Policy_Information_GL_AVG_RATES_October.HomeHealthCare_Exposure, dbo.Policy_Information_GL_AVG_RATES_October.HomeHealthCare_Exposure_Adj, 
                      dbo.Policy_Information_GL_AVG_RATES_October.HomeHealthCare_Avg_Rate, dbo.Policy_Information_GL_AVG_RATES_October.HomeHealthCare_Avg_Rate_Range, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_October.HomeHealthCareSales_Avg_Rate_Range, dbo.Latest_All_Lines_View_1.programdesc, 
                      ...
                      dbo.Latest_All_Lines_View_1.Account_Premium_Range
