IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Dominant_Territory_CO]') AND type in (N'U'))
DROP TABLE [dbo].[Dominant_Territory_CO]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Dominant_Territory_CO]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Dominant_Territory_CO](
