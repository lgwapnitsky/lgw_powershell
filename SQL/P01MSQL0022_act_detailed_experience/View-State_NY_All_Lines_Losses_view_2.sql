IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_NY_All_Lines_Losses_view_2]'))
DROP VIEW [dbo].[State_NY_All_Lines_Losses_view_2]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_NY_All_Lines_Losses_view_2]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_NY_All_Lines_Losses_view_2
AS
