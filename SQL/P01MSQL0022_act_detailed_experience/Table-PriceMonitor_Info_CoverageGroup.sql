IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PriceMonitor_Info_CoverageGroup]') AND type in (N'U'))
DROP TABLE [dbo].[PriceMonitor_Info_CoverageGroup]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PriceMonitor_Info_CoverageGroup]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[PriceMonitor_Info_CoverageGroup](
