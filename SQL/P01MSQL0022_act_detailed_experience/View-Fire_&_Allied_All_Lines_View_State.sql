IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Fire_&_Allied_All_Lines_View_State]'))
DROP VIEW [dbo].[Fire_&_Allied_All_Lines_View_State]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Fire_&_Allied_All_Lines_View_State]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.[Fire_&_Allied_All_Lines_View_State]
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Latest_All_Lines_View_1.Account_RepLoss_Ratio, dbo.Latest_All_Lines_View_1.Account_RepLoss_Ratio_NonCat, dbo.Latest_All_Lines_View_1.CompanyCode, 
                      dbo.Latest_All_Lines_View_1.Endorsement_HS_004, dbo.Latest_All_Lines_View_1.reportmixname, dbo.Latest_All_Lines_View_1.Account_Premium_Range, 
                      dbo.Latest_All_Lines_View_1.programdesc, dbo.Latest_All_Lines_View_1.PICProducer, dbo.Latest_All_Lines_View_1.PrimaryProducer, 
                      dbo.Latest_All_Lines_View_1.PrimaryProducerType, dbo.Latest_All_Lines_View_1.SLD_BusinessType, dbo.Latest_All_Lines_View_1.COL_Breach_of_Contract_Count, 
                      dbo.Latest_All_Lines_View_1.COL_Breach_of_Contract_Loss, dbo.Latest_All_Lines_View_1.COL_Discrimination_Count, 
                      dbo.Latest_All_Lines_View_1.COL_Discrimination_Loss, dbo.Latest_All_Lines_View_1.COL_Wrongful_Termination_Count, 
                      dbo.Latest_All_Lines_View_1.COL_Wrongful_Termination_Loss, dbo.Latest_All_Lines_View_1.COL_Harrassment_Count, 
                      dbo.Latest_All_Lines_View_1.COL_Harrassment_Loss, dbo.Latest_All_Lines_View_1.COL_DO_Other_Count, dbo.Latest_All_Lines_View_1.COL_DO_Other_Loss, 
                      dbo.Latest_All_Lines_View_1.COL_EPL_Other_Count, dbo.Latest_All_Lines_View_1.COL_EPL_Other_Loss, dbo.Latest_All_Lines_View_1.COL_Fiduciary_Other_Count, 
                      dbo.Latest_All_Lines_View_1.COL_Fiduciary_Other_Loss, dbo.Latest_All_Lines_View_1.COL_Worplace_Violence_Other_Count, 
                      dbo.Latest_All_Lines_View_1.COL_Worplace_Violence_Other_Loss, dbo.Latest_All_Lines_View_1.COL_SLD_All_Other_Count, 
                      dbo.Latest_All_Lines_View_1.COL_SLD_All_Other_Loss, dbo.Latest_All_Lines_View_1.County_Pop_Density_Range, dbo.Latest_All_Lines_View_1.Bylaws_YN, 
                      dbo.Latest_All_Lines_View_1.Clean_Warranty_Letter_Received_YN, dbo.Latest_All_Lines_View_1.Disciplinary_Administrative_or_Criminal_Actions_YN, 
                      ...
                      dbo.Latest_All_Lines_View_1.Product_Research_or_Development_Testing_Certif_Services_YN, dbo.Latest_All_Lines_View_1.Proper_Employment_Procedures_YN, 
                      dbo.Latest_All_Lines_View_1.Peer_Review_or_Disciplinary_Action_YN, dbo.Latest_All_Lines_View_1.Positive_Fund_Balance_YN, 
                      dbo.Latest_All_Lines_View_1.Plan_Assets_Range, dbo.Latest_All_Lines_View_1.Supplemental_Claim_Form_Loss_Run_YN, 
                      dbo.Latest_All_Lines_View_1.Security_Precautions_YN, dbo.Latest_All_Lines_View_1.Subsidiaries_Affiliates_YN, 
                      dbo.Latest_All_Lines_View_1.Supp_Claim_Form_Received_YN, dbo.Latest_All_Lines_View_1.Turnover_Rate_Range, dbo.Latest_All_Lines_View_1.Tax_Exempt_YN, 
                      ...
                      dbo.Latest_All_Lines_View_1.PV_Cov_ALL, LEFT(dbo.Latest_All_Lines_View_1.Insd_Zip, 3) AS Zip3
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_September ON 
                      dbo.Latest_All_Lines_View_1.Coverage_Group = dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_September.coverage_group AND 
                      dbo.Latest_All_Lines_View_1.productcode = dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_September.Productcode AND 
                      dbo.Latest_All_Lines_View_1.statecode = dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_September.statecode AND 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_September.policynumber
WHERE     (dbo.Latest_All_Lines_View_1.statecode = ''PA'') AND (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2007) AND 
                      (dbo.Latest_All_Lines_View_1.Coverage_Reporting_group = ''Fire & Allied'')
' 
GO
