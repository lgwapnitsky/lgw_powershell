IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_AZ_All_Lines_view_1]'))
DROP VIEW [dbo].[State_AZ_All_Lines_view_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_AZ_All_Lines_view_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_AZ_All_Lines_view_1
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_May.statecode, dbo.ALL_POLICIES_12_premium_summary_May.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_AUTO_May.Auto_Vehicle_count_Dual_Control_Percent_Range, dbo.Policy_Information_ALL_POLICIES_AUTO_May.Hired_Auto, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_May.Non_Owned_Auto, dbo.Policy_Information_GL_AVG_RATES_May.Churches_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_May.Day_Care_Avg_Rate_Range, dbo.Policy_Information_ALL_POLICIES_May.Primary_Producer_code, 
                      dbo.Policy_Information_ALL_POLICIES_May.Account_RepLoss_Ratio_NonCat_Working_Cover_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_May.Account_UltLoss_Ratio_NonCat_Working_Cover_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_May.Account_UltLoss_Ratio_Working_Cover_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_May.Account_RepLoss_Ratio_Working_Cover_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_May.Account_RepLoss_Ratio_NonCat_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_May.Account_UltLoss_Ratio_NonCat_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_May.Account_RepLoss_Ratio_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_May.Account_UltLoss_Ratio_priorpolperiods_Range, 
                      dbo.Policy_Information_ALL_POLICIES_May.Account_RepLoss_Ratio_NonCat_Range, 
                      dbo.Policy_Information_ALL_POLICIES_May.Account_UltLoss_Ratio_NonCat_Working_Cover_Range, 
                      dbo.Policy_Information_ALL_POLICIES_May.Account_RepLoss_Ratio_NonCat_Working_Cover_Range, 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_May.Price_Monitor_Standard_Cov_Grp_Monitored_range, AccessPHLYEOM.dbo.Division.DivisionName, 
                      AccessPHLYEOM.dbo.product.producttype, dbo.ALL_POLICIES_12_premium_summary_May.Fiscal_AY_Month_Ending, 
                      dbo.ALL_POLICIES_12_premium_summary_May.Last_Reporting_Year, dbo.ALL_POLICIES_12_premium_summary_May.Last_Reporting_Month, 
                      dbo.Policy_Information_ALL_POLICIES_May.PIC_Producer, dbo.Policy_Information_ALL_POLICIES_May.First_Policy_Year, 
                      dbo.Policy_Information_ALL_POLICIES_May.underwriter, dbo.Policy_Information_ALL_POLICIES_May.BusinessClassDesc, 
                      dbo.Policy_Information_ALL_POLICIES_May.Source_Detail_Name, dbo.Policy_PATHID_Information.PICProducer
FROM         dbo.Policy_Information_ALL_POLICIES_AUTO_May RIGHT OUTER JOIN
                      dbo.ALL_POLICIES_12_premium_summary_May ON 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_May.policynumber = dbo.ALL_POLICIES_12_premium_summary_May.policynumber LEFT OUTER JOIN
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_May.Coverage_Group = dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_May.coverage_group LEFT OUTER JOIN
                      dbo.Policy_PATHID_Information INNER JOIN
                      AccessPHLYEOM.dbo.product ON dbo.Policy_PATHID_Information.productcode = AccessPHLYEOM.dbo.product.productcode LEFT OUTER JOIN
                      AccessPHLYEOM.dbo.Division ON AccessPHLYEOM.dbo.product.DivisionID = AccessPHLYEOM.dbo.Division.DivisionID ON 
                      dbo.ALL_POLICIES_12_premium_summary_May.policynumber = dbo.Policy_PATHID_Information.policynumber AND 
                      dbo.ALL_POLICIES_12_premium_summary_May.productcode = AccessPHLYEOM.dbo.product.productcode
GROUP BY dbo.ALL_POLICIES_12_premium_summary_May.statecode, dbo.ALL_POLICIES_12_premium_summary_May.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_May.Account_Name, dbo.Policy_Information_ALL_POLICIES_AUTO_May.Auto_Vehicle_count_Total_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_May.Auto_Vehicle_count_Truck_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_May.Auto_Vehicle_count_PPT_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_May.Auto_Vehicle_count_Buses_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_May.Auto_Vehicle_count_VanPools_Range, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_May.underwriter, dbo.Policy_Information_ALL_POLICIES_May.BusinessClassDesc, 
                      dbo.Policy_Information_ALL_POLICIES_May.Source_Detail_Name, dbo.Policy_PATHID_Information.PICProducer
HAVING      (dbo.ALL_POLICIES_12_premium_summary_May.statecode = ''AZ'')
' 
GO
