IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_PA_All_Lines_View_1_HB]'))
DROP VIEW [dbo].[State_PA_All_Lines_View_1_HB]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_PA_All_Lines_View_1_HB]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_PA_All_Lines_View_1_HB
AS
