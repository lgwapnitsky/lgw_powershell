IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[CA_All_Lines_View_1]'))
DROP VIEW [dbo].[CA_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[CA_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.CA_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_GL_July.[PI-CAM-001]
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      dbo.Policy_Information_ALL_POLICIES_GL_July ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_ALL_POLICIES_GL_July.policynumber
WHERE     (dbo.Latest_All_Lines_View_1.productcode = ''CA'')
' 
GO
