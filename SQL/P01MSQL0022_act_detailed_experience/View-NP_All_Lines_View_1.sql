IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[NP_All_Lines_View_1]'))
DROP VIEW [dbo].[NP_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[NP_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.NP_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Latest_All_Lines_View_1.Primary_Umbrella, dbo.Latest_All_Lines_View_1.Earned_TIV, dbo.Latest_All_Lines_View_1.GL_Dom_Terr_Description, 
                      ...
                      dbo.Latest_All_Lines_View_1.accountnumber, dbo.Latest_All_Lines_View_1.Primary_Producer_type, dbo.Latest_All_Lines_View_1.Incurred_Loss_ALAE_with_SS, 
                      ...
                      dbo.Latest_All_Lines_View_1.Ult_LDF_Capped_Inc_Loss_ALAE_with_SS, dbo.Latest_All_Lines_View_1.GLDX_Indicator, 
                      dbo.Latest_All_Lines_View_1.SAM_Form_Group, dbo.Latest_All_Lines_View_1.Endorsement_GLDX_YN, dbo.Latest_All_Lines_View_1.policynumber, 
                      ...
                      dbo.Latest_All_Lines_View_1.FA_Avg_Bld_Rate_rd2, dbo.Latest_All_Lines_View_1.COL_Prop_Wind_Hail_Count, 
                      ...
                      dbo.Latest_All_Lines_View_1.Earned_Buildings, dbo.Latest_All_Lines_View_1.Earned_Locations, dbo.Latest_All_Lines_View_1.Playground_YN, 
                      ...
                      dbo.Latest_All_Lines_View_1.Number_of_Swimming_Pools_Range, dbo.Latest_All_Lines_View_1.GL_Aggregate_Limit, dbo.Latest_All_Lines_View_1.GL_Deductible, 
                      dbo.Latest_All_Lines_View_1.SAM_Form, dbo.Latest_All_Lines_View_1.SAM_OCC_Limit, dbo.Latest_All_Lines_View_1.SAM_Agg_Limit, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_April.Sales_Service_Orgs_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_April.Sales_Service_Orgs_Avg_Rate, 
                      dbo.Policy_Information_GL_AVG_RATES_April.Sales_Service_Orgs_Exposure_Adj, dbo.Policy_Information_GL_AVG_RATES_April.Sales_Service_Orgs_Exposure, 
                      dbo.Policy_Information_GL_AVG_RATES_April.Sales_Service_Orgs_Premium, dbo.Policy_Information_GL_AVG_RATES_April.Sales_Service_Orgs_Class_Group, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCare_Class_Group, dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCare_Premium, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCare_Exposure, dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCare_Exposure_Adj, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCare_Avg_Rate, dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCare_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCareNonSales_Class_Group, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCareNonSales_Premium, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCareNonSales_Exposure, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCareNonSales_Exposure_Adj, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCareNonSales_Avg_Rate, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCareNonSales_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCareSales_Class_Group, dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCareSales_Premium, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCareSales_Exposure, dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCareSales_Exposure_Adj, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCareSales_Avg_Rate, 
                      dbo.Policy_Information_GL_AVG_RATES_April.HomeHealthCareSales_Avg_Rate_Range, dbo.Latest_All_Lines_View_1.Endorsement_HS_004, 
                      ...
                      dbo.Latest_All_Lines_View_1.Endorsement_HS_003, dbo.Latest_All_Lines_View_1.Endorsement_HS_003D
