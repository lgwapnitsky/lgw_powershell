IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Temp_NP_All_Lines]') AND type in (N'U'))
DROP TABLE [dbo].[Temp_NP_All_Lines]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Temp_NP_All_Lines]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Temp_NP_All_Lines](
