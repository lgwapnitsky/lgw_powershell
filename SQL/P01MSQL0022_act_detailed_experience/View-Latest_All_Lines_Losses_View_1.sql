IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_All_Lines_Losses_View_1]'))
DROP VIEW [dbo].[Latest_All_Lines_Losses_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_All_Lines_Losses_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE view dbo.Latest_All_Lines_Losses_View_1
AS
SELECT     dbo.ALL_POLICIES_12_Detail_Information_1_June.Claim_Number, dbo.ALL_POLICIES_12_Detail_Information_1_June.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_PATHID_Information.Source_Detail_Name, dbo.Policy_PATHID_Information.BusinessClassDesc, dbo.Policy_PATHID_Information.producttype, 
                      dbo.Policy_PATHID_Information.DivisionName, dbo.Policy_PATHID_Information.Account_Premium_Range, dbo.Policy_PATHID_Information.PrimaryProducer, 
                      dbo.Policy_PATHID_Information.PrimaryProducerType, dbo.Policy_PATHID_Information.PICProducer, dbo.Policy_PATHID_Information.Written_Premium_Range, 
                      dbo.Policy_PATHID_Information.Number_of_Renewals, dbo.Policy_PATHID_Information.regiondesc, dbo.Policy_PATHID_Information.program, 
                      dbo.Policy_PATHID_Information.underwriterName, dbo.Policy_PATHID_Information.NewRenewalAuto, dbo.Policy_PATHID_Information.Product_group, 
                      dbo.Policy_PATHID_Information.accountname, dbo.Policy_PATHID_Information.Number_of_SubsequentRenewals, 
                      dbo.ALL_POLICIES_12_Detail_Information_1_June.Policy_Number AS policynumber, dbo.Policy_PATHID_Information.PrimaryProducerNumber, 
                      ...
                      dbo.Policy_PATHID_Information.FF_Cov_ALL, dbo.Policy_PATHID_Information.programdesc, dbo.ALL_POLICIES_12_Detail_Information_1_June.Premium_State, 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.statecode, dbo.Policy_PATHID_Information.Policynumber_or_PATHID, 
                      dbo.Policy_PATHID_Information.SubProduct, dbo.Policy_PATHID_Information.SubProductGroup
FROM         dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June RIGHT OUTER JOIN
                      dbo.ALL_POLICIES_12_Detail_Information_1_June LEFT OUTER JOIN
                      dbo.Policy_PATHID_Information ON dbo.ALL_POLICIES_12_Detail_Information_1_June.Policy_Number = dbo.Policy_PATHID_Information.Policynumber_or_PATHID ON 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.coverage_group = dbo.ALL_POLICIES_12_Detail_Information_1_June.Coverage_Group AND 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.Productcode = dbo.ALL_POLICIES_12_Detail_Information_1_June.Product AND 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.statecode = dbo.ALL_POLICIES_12_Detail_Information_1_June.Accident_State_for_join AND 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.policynumber = dbo.ALL_POLICIES_12_Detail_Information_1_June.Policy_Number
' 
GO
