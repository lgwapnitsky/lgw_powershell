IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Price_Monitor_Latest_Tiein]') AND type in (N'U'))
DROP TABLE [dbo].[Price_Monitor_Latest_Tiein]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Price_Monitor_Latest_Tiein]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Price_Monitor_Latest_Tiein](
