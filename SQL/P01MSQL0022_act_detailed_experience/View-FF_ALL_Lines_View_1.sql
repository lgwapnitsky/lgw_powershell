IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[FF_ALL_Lines_View_1]'))
DROP VIEW [dbo].[FF_ALL_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[FF_ALL_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'
CREATE VIEW dbo.FF_ALL_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_March.Clubs_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_March.Driving_Range_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_March.Golf_Municipal_Public_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_March.Golf_Club_Country_Club_Avg_Rate_Range, 
                      dbo.Policy_Information_Underwriting_Check_List_March.Liquor_Liability_YN, 
                      dbo.Policy_Information_GL_AVG_RATES_March.Swimming_Pools_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_March.Miniature_Golf_Avg_Rate_Range, dbo.Latest_All_Lines_View_1.CompanyCode, 
                      ...
                      dbo.Policy_Information_FF_March.FF_DO_RatingClass, dbo.Policy_Information_FF_March.TrimBusiness_Type, 
                      dbo.Policy_Information_FF_March.FF_EPL_RatingClass, dbo.Policy_Information_FF_March.FF_EPL_Num_of_Employees_Range, 
                      dbo.Policy_Information_FF_March.FF_EPL_Limit, dbo.Policy_Information_FF_March.FF_DO_Limit, 
                      dbo.Policy_Information_FF_March.FF_DO_Alt_Retention_int, dbo.Policy_Information_FF_March.FF_EPL_Alt_Retention_int, 
                      dbo.Policy_Information_FF_March.FF_EPL_Limit_int, dbo.Latest_All_Lines_View_1.Bylaws_YN, 
                      ...
                      dbo.Latest_All_Lines_View_1.Account_ProductType_P, dbo.Latest_All_Lines_View_1.Written_Premium_Range_for_Product
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      dbo.Policy_Information_FF_March ON dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_FF_March.policynumber LEFT OUTER JOIN
                      dbo.Policy_Information_Underwriting_Check_List_March ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_Underwriting_Check_List_March.policynumber LEFT OUTER JOIN
                      dbo.Policy_Information_GL_AVG_RATES_March ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_GL_AVG_RATES_March.Policynumber
WHERE     (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2008) AND (dbo.Latest_All_Lines_View_1.productcode = ''ff'') ' 
GO
