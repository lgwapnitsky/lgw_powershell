IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_All_Lines_Losses_View_1_June]'))
DROP VIEW [dbo].[Latest_All_Lines_Losses_View_1_June]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_All_Lines_Losses_View_1_June]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW [dbo].[Latest_All_Lines_Losses_View_1_June]
AS
SELECT     dbo.ALL_POLICIES_12_Detail_Information_1_June.Claim_Number, dbo.ALL_POLICIES_12_Detail_Information_1_June.Coverage_Reporting_group, 
                      ...
                      dbo.ALL_POLICIES_12_Detail_Information_1_June.Exp_product, 
                      ...
                      dbo.Policy_PATHID_Information.Number_of_SubsequentRenewals, dbo.ALL_POLICIES_12_Detail_Information_1_June.Policy_Number, 
...
FROM         dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June RIGHT OUTER JOIN
                      ...
                      dbo.ALL_POLICIES_12_Detail_Information_1_June.Policy_Number = dbo.Policy_PATHID_Information.policynumber ON 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.coverage_group = dbo.ALL_POLICIES_12_Detail_Information_1_June.Coverage_Group
                       AND dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.Productcode = dbo.ALL_POLICIES_12_Detail_Information_1_June.Product AND 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.statecode = dbo.ALL_POLICIES_12_Detail_Information_1_June.Accident_State_for_join
                       AND 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.policynumber = dbo.ALL_POLICIES_12_Detail_Information_1_June.Policy_Number LEFT
                       OUTER JOIN
