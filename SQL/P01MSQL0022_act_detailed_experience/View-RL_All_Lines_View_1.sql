IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[RL_All_Lines_View_1]'))
DROP VIEW [dbo].[RL_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[RL_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.RL_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_LATEST_View_1.Churches_Avg_Rate_Range, dbo.Latest_All_Lines_View_1.CompanyCode, 
...
WHERE     (dbo.Latest_All_Lines_View_1.productcode = ''RL'') AND (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2007)
' 
GO
