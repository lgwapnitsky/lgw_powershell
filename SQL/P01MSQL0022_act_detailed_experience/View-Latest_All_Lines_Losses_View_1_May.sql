IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_All_Lines_Losses_View_1_May]'))
DROP VIEW [dbo].[Latest_All_Lines_Losses_View_1_May]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_All_Lines_Losses_View_1_May]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.Latest_All_Lines_Losses_View_1_May
AS
SELECT     dbo.ALL_POLICIES_12_Detail_Information_1_May.Claim_Number, dbo.ALL_POLICIES_12_Detail_Information_1_May.Coverage_Reporting_group, 
                      dbo.ALL_POLICIES_12_Detail_Information_1_May.Coverage_Form, dbo.ALL_POLICIES_12_Detail_Information_1_May.Accident_Year, 
                      ...
                      dbo.ALL_POLICIES_12_Detail_Information_1_May.Claim_Desc, dbo.ALL_POLICIES_12_Detail_Information_1_May.Case_Loss, 
                      dbo.ALL_POLICIES_12_Detail_Information_1_May.Case_ALAE, dbo.ALL_POLICIES_12_Detail_Information_1_May.Paid_Loss, 
                      dbo.ALL_POLICIES_12_Detail_Information_1_May.Paid_ALAE, dbo.ALL_POLICIES_12_Detail_Information_1_May.Sal_Subro, 
                      dbo.ALL_POLICIES_12_Detail_Information_1_May.Incurred_Loss_ALAE_with_SS, 
                      ...
                      dbo.ALL_POLICIES_12_Detail_Information_1_May.Accident_State, dbo.ALL_POLICIES_12_Detail_Information_1_May.Accident_State_for_join, 
                      dbo.ALL_POLICIES_12_Detail_Information_1_May.Exp_product, 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_May.GL_Dom_Region_in_State, 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_May.GL_Dom_Terr_Description, dbo.Policy_PATHID_Information.reportmixname, 
                      ...
                      dbo.Policy_PATHID_Information.Number_of_SubsequentRenewals, dbo.ALL_POLICIES_12_Detail_Information_1_May.Policy_Number, 
...
FROM         dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_May RIGHT OUTER JOIN
                      dbo.ALL_POLICIES_12_Detail_Information_1_May LEFT OUTER JOIN
                      dbo.Policy_PATHID_Information ON 
                      dbo.ALL_POLICIES_12_Detail_Information_1_May.Policy_Number = dbo.Policy_PATHID_Information.policynumber ON 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_May.coverage_group = dbo.ALL_POLICIES_12_Detail_Information_1_May.Coverage_Group AND
                       dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_May.Productcode = dbo.ALL_POLICIES_12_Detail_Information_1_May.Product AND 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_May.statecode = dbo.ALL_POLICIES_12_Detail_Information_1_May.Accident_State_for_join AND
                       dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_May.policynumber = dbo.ALL_POLICIES_12_Detail_Information_1_May.Policy_Number LEFT
                       OUTER JOIN
