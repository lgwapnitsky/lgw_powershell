IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[California_All_LOB-view_1]'))
DROP VIEW [dbo].[California_All_LOB-view_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[California_All_LOB-view_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.[California_All_LOB-view_1]
AS
SELECT     dbo.ALL_POLICIES_15_premium_summary.statecode, dbo.ALL_POLICIES_15_premium_summary.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES.Written_Premium_Range, dbo.ALL_POLICIES_15_premium_summary.Coverage_Group, 
                      dbo.Policy_Information_ALL_POLICIES.product_group, dbo.Policy_Information_ALL_POLICIES.Primary_Umbrella, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary.Earned_Buildings) AS Earned_Buildings, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary.Earned_Locations) AS Earned_Locations, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary.Earned_TIV) AS Earned_TIV, dbo.Policy_Information_ALL_POLICIES.Account_Premium_range, 
                      dbo.Policy_Information_ALL_POLICIES.FA_Constr_Code_Dominant_NAME, dbo.Policy_Information_ALL_POLICIES.SAM_Form_Group, 
                      dbo.Policy_Information_ALL_POLICIES.Account_Loss_Ratio_Working_Cover_Range, 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES.GL_Dom_Region_in_State AS Expr1
...
GROUP BY dbo.ALL_POLICIES_15_premium_summary.statecode, dbo.ALL_POLICIES_15_premium_summary.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES.Written_Premium_Range, dbo.ALL_POLICIES_15_premium_summary.Coverage_Group, 
                      dbo.Policy_Information_ALL_POLICIES.product_group, dbo.Policy_Information_ALL_POLICIES.Primary_Umbrella, 
                      dbo.Policy_Information_ALL_POLICIES.Account_Premium_range, dbo.Policy_Information_ALL_POLICIES.FA_Constr_Code_Dominant_NAME, 
                      dbo.Policy_Information_ALL_POLICIES.SAM_Form_Group, dbo.Policy_Information_ALL_POLICIES.Account_Loss_Ratio_Working_Cover_Range, 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES.GL_Dom_Region_in_State
HAVING      (dbo.Policy_Information_ALL_POLICIES.Primary_Umbrella = ''Primary'') AND (dbo.ALL_POLICIES_15_premium_summary.statecode = ''CA'')
' 
GO
