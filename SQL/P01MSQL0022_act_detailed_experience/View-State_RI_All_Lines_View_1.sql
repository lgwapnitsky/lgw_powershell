IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_RI_All_Lines_View_1]'))
DROP VIEW [dbo].[State_RI_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_RI_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_RI_All_Lines_View_1
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_March.statecode, dbo.ALL_POLICIES_12_premium_summary_March.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_Underwriting_Check_List_March.Playground_YN, dbo.Policy_Information_Underwriting_Check_List_March.Playground_Equip_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_March.Pool_YN, dbo.Policy_Information_Underwriting_Check_List_March.Sports_Activities_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_March.Tennis_Bubble_YN, dbo.Policy_Information_Underwriting_Check_List_March.Tennis_Courts_YN, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_March.Property_Coverage_Form, dbo.ALL_POLICIES_12_premium_summary_March.Coverage_Form, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_March.Churches_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_March.Day_Care_Avg_Rate_Range, 
                      dbo.Policy_Information_ALL_POLICIES_March.Primary_Producer_code, 
                      ...
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_March.Price_Monitor_Standard_Cov_Grp_Monitored_range, AccessPHLYEOM.dbo.Division.DivisionName, 
                      AccessPHLYEOM.dbo.product.producttype, dbo.ALL_POLICIES_12_premium_summary_March.Fiscal_AY_Month_Ending, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_March.PIC_Producer, dbo.Policy_Information_ALL_POLICIES_March.First_Policy_Year, 
                      dbo.Policy_Information_ALL_POLICIES_March.underwriter, dbo.Policy_Information_ALL_POLICIES_March.BusinessClassDesc, 
                      dbo.Policy_Information_ALL_POLICIES_March.Source_Detail_Name
FROM         dbo.ALL_POLICIES_12_premium_summary_March LEFT OUTER JOIN
                      AccessPHLYEOM.dbo.product ON dbo.ALL_POLICIES_12_premium_summary_March.productcode = AccessPHLYEOM.dbo.product.productcode LEFT OUTER JOIN
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_March.statecode, dbo.ALL_POLICIES_12_premium_summary_March.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_March.GL_Dom_Region_in_State, dbo.Policy_Information_ALL_POLICIES_March.Primary_Producer, 
                      dbo.Policy_Information_ALL_POLICIES_March.Account_UltLoss_Ratio_Working_Cover_Range, 
                      dbo.Policy_Information_ALL_POLICIES_March.Account_RepLoss_Ratio_Working_Cover_Range, dbo.Policy_Information_ALL_POLICIES_March.accountnumber, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_March.underwriter, dbo.Policy_Information_ALL_POLICIES_March.BusinessClassDesc, 
                      dbo.Policy_Information_ALL_POLICIES_March.Source_Detail_Name
HAVING      (dbo.ALL_POLICIES_12_premium_summary_March.statecode = ''RI'')
' 
GO
