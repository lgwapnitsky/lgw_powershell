IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DY_Dominant_Territory]') AND type in (N'U'))
DROP TABLE [dbo].[DY_Dominant_Territory]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DY_Dominant_Territory]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[DY_Dominant_Territory](
	...
	[GL_Major_Region_in_State] [varchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
END
GO
