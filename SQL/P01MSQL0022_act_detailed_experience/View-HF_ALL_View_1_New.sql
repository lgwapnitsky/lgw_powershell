IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[HF_ALL_View_1_New]'))
DROP VIEW [dbo].[HF_ALL_View_1_New]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[HF_ALL_View_1_New]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.HF_ALL_View_1_New
AS
SELECT     dbo.ALL_POLICIES_15_premium_summary_B.statecode, dbo.ALL_POLICIES_15_premium_summary_B.Coverage_Reporting_group, 
                      ...
                      dbo.ALL_POLICIES_15_premium_summary_B.Coverage_Group, dbo.Policy_Information_ALL_POLICIES_B.product_group, 
                      dbo.Policy_Information_ALL_POLICIES_B.Primary_Umbrella, SUM(dbo.ALL_POLICIES_15_premium_summary_B.Earned_Buildings) 
                      AS Earned_Buildings, SUM(dbo.ALL_POLICIES_15_premium_summary_B.Earned_Locations) AS Earned_Locations, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.Earned_TIV) AS Earned_TIV, 
                      ...
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.Policy_count_All_Cov_Combined) AS Policy_count_All_Cov_Combined, 
                      ...
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.Policy_count_Coverage_Group) AS Policy_count_Coverage_Group, 
                      dbo.Policy_Information_ALL_POLICIES_B.accountnumber, dbo.Policy_Information_ALL_POLICIES_B.Account_Name, 
                      dbo.Policy_Information_ALL_POLICIES_B.Primary_Producer_type, dbo.Policy_Information_GL_AVG_RATES_B.Condo_Association_Avg_Rate_Range, 
                      dbo.Policy_Information_Underwriting_Check_List_B.Pool_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_B.Number_of_Swimming_Pools_Range, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.Incurred_Loss_ALAE_with_SS) AS Incurred_Loss_ALAE_with_SS, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.Capped_Incurred_Loss_ALAE_with_SS) AS Capped_Incurred_Loss_ALAE_with_SS, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.Ult_LDF_Incurred_Loss_ALAE_with_SS) AS Ult_LDF_Incurred_Loss_ALAE_with_SS, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.Ult_LDF_Capped_Inc_Loss_ALAE_with_SS) AS Ult_LDF_Capped_Inc_Loss_ALAE_with_SS, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_B.Endorsement_GLDX_YN, dbo.ALL_POLICIES_15_premium_summary_B.policynumber, 
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_B.Property_Coverage_Form, dbo.ALL_POLICIES_15_premium_summary_B.Coverage_Form, 
                      ...
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.COL_Prop_Wind_Hail_Count) AS COL_Prop_Wind_Hail_Count, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.COL_Prop_Wind_Hail_Loss) AS COL_Prop_Wind_Hail_Loss, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.COL_Prop_Water_Other_Loss) AS COL_Prop_Water_Other_Loss, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.COL_Prop_Water_Other_Count) AS COL_Prop_Water_Other_Count, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.COL_Prop_Water_Sprinkler_Loss) AS COL_Prop_Water_Sprinkler_Loss, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.COL_Prop_Water_Sprinkler_Count) AS COL_Prop_Water_Sprinkler_Count, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.COL_Prop_Theft_Van_Loss) AS COL_Prop_Theft_Van_Loss, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.COL_Prop_Theft_Van_Count) AS COL_Prop_Theft_Van_Count, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.COL_Prop_Fire_Lightning_Explosion_Loss) AS COL_Prop_Fire_Lightning_Explosion_Loss, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.COL_Prop_Fire_Lightning_Explosion_Count) AS COL_Prop_Fire_Lightning_Explosion_Count, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.COL_Prop_Other_Loss) AS COL_Prop_Other_Loss, 
                      SUM(dbo.ALL_POLICIES_15_premium_summary_B.COL_Prop_Other_Count) AS COL_Prop_Other_Count, 
                      dbo.Policy_Information_ALL_POLICIES_B.Endorsement_Elite_YN, dbo.Policy_Information_ALL_POLICIES_B.Prior_Policy_number, 
                      dbo.Policy_Information_ALL_POLICIES_B.prior_policynumber_2, dbo.Policy_Information_ALL_POLICIES_B.prior_policynumber_3, 
                      dbo.Policy_Information_ALL_POLICIES_B.prior_policynumber_4, dbo.Policy_Information_ALL_POLICIES_B.prior_policynumber_5, 
                      dbo.Policy_Information_ALL_POLICIES_B.prior_policynumber_6, dbo.Policy_Information_ALL_POLICIES_B.prior_policynumber_7, 
                      dbo.Policy_Information_ALL_POLICIES_B.New_Renew_Automatic_Prior_Policy, 
                      dbo.Policy_Information_ALL_POLICIES_B.New_Renew_Automatic_Prior_Policy_2, 
                      dbo.Policy_Information_ALL_POLICIES_B.New_Renew_Automatic_Prior_Policy_3, 
                      dbo.Policy_Information_ALL_POLICIES_B.New_Renew_Automatic_Prior_Policy_4, 
                      dbo.Policy_Information_ALL_POLICIES_B.New_Renew_Automatic_Prior_Policy_5, 
                      dbo.Policy_Information_ALL_POLICIES_B.Written_Premium_Range_for_Product, dbo.Policy_Information_ALL_POLICIES_B.First_Policy_Year
FROM         dbo.ALL_POLICIES_15_premium_summary_B LEFT OUTER JOIN
                      dbo.Policy_Information_Underwriting_Check_List_B ON 
                      dbo.ALL_POLICIES_15_premium_summary_B.policynumber = dbo.Policy_Information_Underwriting_Check_List_B.policynumber LEFT OUTER JOIN
                      dbo.Policy_Information_GL_AVG_RATES_B ON 
                      dbo.ALL_POLICIES_15_premium_summary_B.policynumber = dbo.Policy_Information_GL_AVG_RATES_B.Policynumber LEFT OUTER JOIN
                      ...
                      dbo.ALL_POLICIES_15_premium_summary_B.policynumber = dbo.Policy_Information_ALL_POLICIES_FireAllied_B.policynumber LEFT OUTER JOIN
...
GROUP BY dbo.ALL_POLICIES_15_premium_summary_B.statecode, dbo.ALL_POLICIES_15_premium_summary_B.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_B.Branch_Region, dbo.Policy_Information_ALL_POLICIES_B.program, 
                      dbo.ALL_POLICIES_15_premium_summary_B.Coverage_Group, dbo.Policy_Information_ALL_POLICIES_B.product_group, 
                      dbo.Policy_Information_ALL_POLICIES_B.Primary_Umbrella, dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_B.GL_Dom_Terr_Description, 
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_B.GL_Dom_Region_in_State, dbo.Policy_Information_ALL_POLICIES_B.Primary_Producer, 
                      dbo.Policy_Information_ALL_POLICIES_B.Account_UltLoss_Ratio_Working_Cover_Range, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_B.Account_Name, dbo.Policy_Information_ALL_POLICIES_B.Primary_Producer_type, 
                      dbo.Policy_Information_GL_AVG_RATES_B.Condo_Association_Avg_Rate_Range, dbo.Policy_Information_Underwriting_Check_List_B.Pool_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_B.Number_of_Swimming_Pools_Range, 
                      dbo.Policy_Information_ALL_POLICIES_GL_B.GL_Aggregate_Limit, dbo.Policy_Information_ALL_POLICIES_GL_B.GL_Deductible, 
                      dbo.Policy_Information_ALL_POLICIES_GL_B.GLDX_Indicator, dbo.Policy_Information_ALL_POLICIES_GL_B.SAM_Form, 
                      dbo.Policy_Information_ALL_POLICIES_GL_B.SAM_OCC_Limit, dbo.Policy_Information_ALL_POLICIES_GL_B.SAM_Agg_Limit, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_B.New_Renew_Automatic_Prior_Policy_5, 
                      dbo.Policy_Information_ALL_POLICIES_B.Written_Premium_Range_for_Product, dbo.Policy_Information_ALL_POLICIES_B.First_Policy_Year
HAVING      (dbo.Policy_Information_ALL_POLICIES_B.Primary_Umbrella = ''Primary'') AND (dbo.ALL_POLICIES_15_premium_summary_B.productcode = ''HF'')
' 
GO
