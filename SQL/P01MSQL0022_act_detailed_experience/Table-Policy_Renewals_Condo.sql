IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Policy_Renewals_Condo]') AND type in (N'U'))
DROP TABLE [dbo].[Policy_Renewals_Condo]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Policy_Renewals_Condo]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Policy_Renewals_Condo](
