IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[General_Liability_Detail_Information_1]') AND type in (N'U'))
DROP TABLE [dbo].[General_Liability_Detail_Information_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[General_Liability_Detail_Information_1]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[General_Liability_Detail_Information_1](
