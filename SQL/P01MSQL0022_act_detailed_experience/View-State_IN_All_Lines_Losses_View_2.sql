IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_IN_All_Lines_Losses_View_2]'))
DROP VIEW [dbo].[State_IN_All_Lines_Losses_View_2]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_IN_All_Lines_Losses_View_2]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_IN_All_Lines_Losses_View_2
AS
...
WHERE     (dbo.ALL_POLICIES_12_Detail_Information_1_October.Premium_State = ''IN'')
' 
GO
