IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[HUBDynamicPrompt_InterimFields]') AND type in (N'U'))
DROP TABLE [dbo].[HUBDynamicPrompt_InterimFields]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[HUBDynamicPrompt_InterimFields]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[HUBDynamicPrompt_InterimFields](
