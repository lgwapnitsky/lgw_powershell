IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[ME_All_Lines_View_1]'))
DROP VIEW [dbo].[ME_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[ME_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.ME_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_December.Clubs_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_December.Driving_Range_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_December.Golf_Municipal_Public_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_December.Golf_Club_Country_Club_Avg_Rate_Range, 
                      dbo.Policy_Information_Underwriting_Check_List_December.Liquor_Liability_YN, 
                      dbo.Policy_Information_GL_AVG_RATES_December.Swimming_Pools_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_December.Miniature_Golf_Avg_Rate_Range, dbo.Latest_All_Lines_View_1.CompanyCode, 
...
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      ...
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_Underwriting_Check_List_December.policynumber LEFT OUTER JOIN
                      dbo.Policy_Information_GL_AVG_RATES_December ON 
                      dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_GL_AVG_RATES_December.Policynumber
WHERE     (dbo.Latest_All_Lines_View_1.productcode = ''me'')
' 
GO
