IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Automatic_SLD_Current_Rules]') AND type in (N'U'))
DROP TABLE [dbo].[Automatic_SLD_Current_Rules]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Automatic_SLD_Current_Rules]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Automatic_SLD_Current_Rules](
