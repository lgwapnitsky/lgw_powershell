IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Comm_Auto_Liab_Hired_NonOwned_Detail_2]') AND type in (N'U'))
DROP TABLE [dbo].[Comm_Auto_Liab_Hired_NonOwned_Detail_2]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Comm_Auto_Liab_Hired_NonOwned_Detail_2]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Comm_Auto_Liab_Hired_NonOwned_Detail_2](
