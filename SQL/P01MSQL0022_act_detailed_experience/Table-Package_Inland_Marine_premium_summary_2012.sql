IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Package_Inland_Marine_premium_summary_2012]') AND type in (N'U'))
DROP TABLE [dbo].[Package_Inland_Marine_premium_summary_2012]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Package_Inland_Marine_premium_summary_2012]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Package_Inland_Marine_premium_summary_2012](
	[accountnumber] [int] NULL,
	[policynumber] [varchar](15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[policyeffectivedate] [datetime] NULL,
	[statecode] [varchar](2) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[aslobcode] [int] NULL,
	[Coveragecode] [varchar](6) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[Packagefinal] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
