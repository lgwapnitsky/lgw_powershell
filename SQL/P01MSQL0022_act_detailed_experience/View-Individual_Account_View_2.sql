IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Individual_Account_View_2]'))
DROP VIEW [dbo].[Individual_Account_View_2]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Individual_Account_View_2]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.Individual_Account_View_2
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Latest_All_Lines_View_1.Renew_New_Auto, dbo.Latest_All_Lines_View_1.Branch_Region, dbo.Latest_All_Lines_View_1.Coverage_Group, 
                      ...
                      dbo.Latest_All_Lines_View_1.COL_Prop_Other_Count, dbo.Latest_All_Lines_View_1.Endorsement_Elite_YN, 
                      ...
                      dbo.Latest_All_Lines_View_1.Fiscal_AY_Month_Ending, dbo.Latest_All_Lines_View_1.Last_Reporting_Year, dbo.Latest_All_Lines_View_1.Last_Reporting_Month, 
                      dbo.Latest_All_Lines_View_1.Price_Monitor_Standard_Cov_Grp_Monitored_range, dbo.Latest_All_Lines_View_1.Account_UltLoss_Ratio, 
                      dbo.Latest_All_Lines_View_1.Account_UltLoss_Ratio_NonCat, dbo.Latest_All_Lines_View_1.Account_RepLoss_Ratio, 
                      dbo.Latest_All_Lines_View_1.Account_RepLoss_Ratio_NonCat, dbo.Latest_All_Lines_View_1.Account_RepLoss_Ratio_NonCat_priorpolperiods_Range, 
                      dbo.Latest_All_Lines_View_1.Account_RepLoss_Ratio_priorpolperiods_Range, dbo.Latest_All_Lines_View_1.Renewals_Range, 
                      dbo.Latest_All_Lines_View_1.Branch_Office, dbo.Latest_All_Lines_View_1.Endorsement_HS_004, dbo.Latest_All_Lines_View_1.CSCORE_GMODEL8, 
                      dbo.Latest_All_Lines_View_1.FSCORE_GMODEL7_1, dbo.Latest_All_Lines_View_1.FSCORE_GMODEL7, dbo.Latest_All_Lines_View_1.CSCORE_GMODEL7, 
                      dbo.Latest_All_Lines_View_1.productdesc, dbo.Latest_All_Lines_View_1.prodmixname, dbo.Latest_All_Lines_View_1.ProductTypeName, 
                      dbo.Latest_All_Lines_View_1.reportmixname, dbo.Latest_All_Lines_View_1.accountname, dbo.Latest_All_Lines_View_1.Account_Name, 
                      dbo.Latest_All_Lines_View_1.CompanyCode, dbo.Latest_All_Lines_View_1.Product_group, dbo.Latest_All_Lines_View_1.NewRenewalAuto, 
                      ...
                      dbo.Latest_All_Lines_View_1.Insd_State, dbo.Latest_All_Lines_View_1.Insd_City, dbo.Latest_All_Lines_View_1.Insd_Zip, 
                      dbo.Latest_All_Lines_View_1.underwriterName, dbo.Latest_All_Lines_View_1.regiondesc, dbo.Latest_All_Lines_View_1.programdesc, 
                      dbo.Latest_All_Lines_View_1.program, dbo.Latest_All_Lines_View_1.Written_Premium_Range, dbo.Latest_All_Lines_View_1.Number_of_Renewals, 
                      ...
                      dbo.Latest_All_Lines_View_1.Account_Premium_Range, dbo.Latest_All_Lines_View_1.DivisionName, dbo.Latest_All_Lines_View_1.producttype, 
                      dbo.Latest_All_Lines_View_1.PrimaryProducerNumber, dbo.Latest_All_Lines_View_1.effectivedate, dbo.Latest_All_Lines_View_1.expirationdate, 
                      dbo.Latest_All_Lines_View_1.Insured_Years_Range, dbo.Latest_All_Lines_View_1.SLD_BusinessType, 
                      dbo.Latest_All_Lines_View_1.Incurred_Loss_ALAE_without_SS_NonCat, dbo.Latest_All_Lines_View_1.accountnumber, 
                      dbo.Latest_All_Lines_View_1.Source_Detail_Name, dbo.Latest_All_Lines_View_1.BusinessClassDesc
FROM         dbo.Individual_Accounts_for_Reports_View_2 INNER JOIN
                      dbo.Latest_All_Lines_View_1 ON dbo.Individual_Accounts_for_Reports_View_2.accountnumber = dbo.Latest_All_Lines_View_1.accountnumber
' 
GO
