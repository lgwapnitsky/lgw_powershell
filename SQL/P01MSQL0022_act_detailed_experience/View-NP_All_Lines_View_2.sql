IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[NP_All_Lines_View_2]'))
DROP VIEW [dbo].[NP_All_Lines_View_2]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[NP_All_Lines_View_2]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.NP_All_Lines_View_2
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_April.Clubs_Avg_Rate_Range, dbo.Policy_Information_Underwriting_Check_List_April.Liquor_Liability_YN, 
                      dbo.Policy_Information_GL_AVG_RATES_April.Swimming_Pools_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_April.Amusement_Centers_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_April.Amusement_Parks_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_April.Athletic_Programs_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_April.Concessionaires_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_April.Exhibition_Bldgs_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_April.Exhibitions_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_April.Indoor_play_centers_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_April.Race_Tracks_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_April.Stadiums_Avg_Rate_Range, 
...
WHERE     (dbo.Latest_All_Lines_View_1.productcode IN (''np'', ''fp'', ''me'', ''hm'', ''hc'', ''sa'')) AND (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2008) AND 
