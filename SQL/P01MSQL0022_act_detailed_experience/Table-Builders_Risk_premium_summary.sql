IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Builders_Risk_premium_summary]') AND type in (N'U'))
DROP TABLE [dbo].[Builders_Risk_premium_summary]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Builders_Risk_premium_summary]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Builders_Risk_premium_summary](
	...
	[BR_Number_of_Locations] [int] NULL,
	[BR_Builders_Risk_Exposure] [float] NULL,
	[BR_Extra_Exp_Rental_Income_Exposure] [float] NULL,
	[BR_Builders_Risk_Prem] [float] NULL,
	[BR_Extra_Exp_Rental_Income_Prem] [float] NULL,
	[BR_Deductible] [float] NULL,
	[BR_TIV_Exposure] [float] NULL,
	[BR_TIV_Prem] [float] NULL,
	[BR_TIV_Exposure_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Term_Factor] [float] NULL,
	[BR_Avg_Annual_BR_Rate] [float] NULL,
	[BR_Avg_Annual_EERI_Rate] [float] NULL,
	[BR_Avg_Annual_TIV_Rate] [float] NULL,
	[BR_Avg_Term_BR_Rate] [float] NULL,
	[BR_Avg_Term_EERI_Rate] [float] NULL,
	[BR_Avg_Term_TIV_Rate] [float] NULL,
	[BR_Avg_Annual_TIV_Rate_rd2] [float] NULL,
	[BR_Avg_Term_TIV_Rate_rd2] [float] NULL,
	[BR_Avg_Annual_TIV_Rate_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[BR_Avg_Term_TIV_Rate_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[BR_Constr_code_Tot_Exposure] [float] NULL,
	[BR_Constr_Code_Max_Exposure] [float] NULL,
	[BR_Constr_Code_Dominant] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Class_Code_370_Exposure] [float] NULL,
	[Class_Code_371_Exposure] [float] NULL,
	[Class_Code_372_Exposure] [float] NULL,
	[Class_Code_373_Exposure] [float] NULL,
	[Class_Code_374_Exposure] [float] NULL,
	[Class_Code_375_Exposure] [float] NULL,
	[Class_Code_379_Exposure] [float] NULL,
	[BR_Class_code_Tot_Exposure] [float] NULL,
	[BR_Class_Code_Max_Exposure] [float] NULL,
	[BR_Class_Code_Dominant] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[BR_Class_Code_Dominant_Percent] [float] NULL,
	[Class_Apartments_Exposure] [float] NULL,
	[Class_Apartments_RatingPrem] [float] NULL,
	[Class_Dwelling_Other_Than_Apts_Exposure] [float] NULL,
	[Class_Dwelling_Other_Than_Apts_RatingPrem] [float] NULL,
	[Class_Apartments_AvgTermRate] [float] NULL,
	[Class_Dwelling_Other_Than_Apts_AvgTermRate] [float] NULL,
	[Class_Apartments_AvgTermRate_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Class_Dwelling_Other_Than_Apts_AvgTermRate_Range] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[BR_Constr_Code_Dominant_NAME] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[BR_Class_Code_Dominant_NAME] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
