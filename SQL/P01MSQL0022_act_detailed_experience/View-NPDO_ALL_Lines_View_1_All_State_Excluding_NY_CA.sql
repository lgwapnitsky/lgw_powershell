IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[NPDO_ALL_Lines_View_1_All_State_Excluding_NY_CA]'))
DROP VIEW [dbo].[NPDO_ALL_Lines_View_1_All_State_Excluding_NY_CA]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[NPDO_ALL_Lines_View_1_All_State_Excluding_NY_CA]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.NPDO_ALL_Lines_View_1_All_State_Excluding_NY_CA
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Latest_All_Lines_View_1.County_Pop_Density_Range, dbo.Latest_All_Lines_View_1.Bylaws_YN, 
                      ...
                      dbo.Policy_Information_FF_April_GN.FF_DO_Limit, dbo.Policy_Information_FF_April_GN.FF_DO_RatingClass, dbo.Policy_Information_FF_April_GN.FF_EPL_Limit, 
                      dbo.Policy_Information_FF_April_GN.FF_EPL_RatingClass, dbo.Policy_Information_FF_April_GN.FF_EPL_Num_of_Employees_Range, 
                      dbo.Policy_Information_FF_April_GN.TrimBusiness_Type, dbo.Policy_Information_FF_April_GN.FF_DO_Alt_Retention_int, 
                      dbo.Policy_Information_FF_April_GN.FF_EPL_Limit_int, dbo.Policy_Information_FF_April_GN.FF_EPL_Alt_Retention_int, 
                      dbo.Policy_Information_FF_April_GN.FF_EPL_Num_of_Employees_Range_2
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      dbo.Policy_Information_FF_April_GN ON dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_FF_April_GN.policynumber LEFT OUTER JOIN
...
WHERE     (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2008) AND (dbo.Latest_All_Lines_View_1.productcode = ''ff'') AND 
                      (NOT (dbo.Latest_All_Lines_View_1.statecode IN (''NY'', ''CA'')))
' 
GO
