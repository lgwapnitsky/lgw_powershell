IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PMS_MatchPRP_Quote]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[PMS_MatchPRP_Quote]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PMS_MatchPRP_Quote]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'
CREATE PROCEDURE [dbo].[PMS_MatchPRP_Quote]
...
BEGIN 
	...
	SELECT @PriorPolicyNumber = PriorPolicyNumber FROM PolicySnapshot P WHERE PolicyNumber = @PolicyNumber AND snapshottype = ''E''
