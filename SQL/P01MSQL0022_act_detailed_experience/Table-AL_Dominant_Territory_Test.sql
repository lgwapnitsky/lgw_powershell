IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AL_Dominant_Territory_Test]') AND type in (N'U'))
DROP TABLE [dbo].[AL_Dominant_Territory_Test]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AL_Dominant_Territory_Test]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[AL_Dominant_Territory_Test](
