IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Class_47367_All_Lines_View_1]'))
DROP VIEW [dbo].[Class_47367_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Class_47367_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.Class_47367_All_Lines_View_1
AS
SELECT     dbo.ALL_POLICIES_15_premium_summary_June.statecode, dbo.ALL_POLICIES_15_premium_summary_June.Coverage_Reporting_group, 
                      ...
                      SUM(dbo.ALL_POLICIES_15_premium_summary_June.Earned_TIV) AS Earned_TIV, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_June.Property_Coverage_Form, dbo.ALL_POLICIES_15_premium_summary_June.Coverage_Form, 
...
FROM         dbo.ALL_POLICIES_15_premium_summary_June LEFT OUTER JOIN
                      ...
                      dbo.ALL_POLICIES_15_premium_summary_June.policynumber = dbo.Policy_Information_Underwriting_Check_List_June.policynumber LEFT OUTER JOIN
                      ...
                      dbo.ALL_POLICIES_15_premium_summary_June.policynumber = dbo.Policy_Information_ALL_POLICIES_GL_June.policynumber LEFT OUTER JOIN
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_June ON 
                      dbo.ALL_POLICIES_15_premium_summary_June.policynumber = dbo.Policy_Information_ALL_POLICIES_FireAllied_June.policynumber LEFT OUTER JOIN
                      dbo.Policy_Information_ALL_POLICIES_June ON 
                      dbo.ALL_POLICIES_15_premium_summary_June.policynumber = dbo.Policy_Information_ALL_POLICIES_June.policynumber LEFT OUTER JOIN
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June ON 
                      dbo.ALL_POLICIES_15_premium_summary_June.policynumber = dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.policynumber AND 
                      dbo.ALL_POLICIES_15_premium_summary_June.productcode = dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.Productcode AND 
                      dbo.ALL_POLICIES_15_premium_summary_June.statecode = dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.statecode AND 
                      dbo.ALL_POLICIES_15_premium_summary_June.Coverage_Group = dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_June.coverage_group
...
HAVING      (dbo.Policy_Information_ALL_POLICIES_June.Primary_Umbrella = ''Primary'') AND 
                      (dbo.ALL_POLICIES_15_premium_summary_June.productcode IN (''NP'', ''FP'')) AND 
                      (dbo.Policy_Information_ALL_POLICIES_June.accountnumber IN
                          (SELECT DISTINCT accountnumber
                            FROM          AccessPhlyEom.dbo.premiumsummary
                            WHERE      (classcode = ''47367'') AND (productcode IN (''NP'', ''FP''))))
' 
GO
