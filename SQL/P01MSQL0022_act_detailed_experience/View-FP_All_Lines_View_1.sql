IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[FP_All_Lines_View_1]'))
DROP VIEW [dbo].[FP_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[FP_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.FP_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_October.Clubs_Avg_Rate_Range, dbo.Policy_Information_Underwriting_Check_List_October.Liquor_Liability_YN, 
                      dbo.Policy_Information_GL_AVG_RATES_October.Swimming_Pools_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_October.Amusement_Centers_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_October.Amusement_Parks_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_October.Athletic_Programs_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_October.Concessionaires_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_October.Exhibition_Bldgs_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_October.Exhibitions_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_October.Indoor_play_centers_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_October.Race_Tracks_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_October.Stadiums_Avg_Rate_Range, 
                      dbo.Latest_All_Lines_View_1.CompanyCode, dbo.Latest_All_Lines_View_1.programdesc, dbo.Latest_All_Lines_View_1.PICProducer, 
                      ...
                      dbo.Latest_All_Lines_View_1.policyexpirationdate, dbo.Latest_All_Lines_View_1.policyEffectivedate
...
WHERE     (dbo.Latest_All_Lines_View_1.productcode = ''fp'') AND (dbo.Latest_All_Lines_View_1.DivisionName = ''CL'')
' 
GO
