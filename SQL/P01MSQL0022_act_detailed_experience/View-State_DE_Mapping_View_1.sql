IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_DE_Mapping_View_1]'))
DROP VIEW [dbo].[State_DE_Mapping_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_DE_Mapping_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_DE_Mapping_View_1
AS
...
WHERE     (Act_Exposure_Mgt.dbo.Property_General_2010_06_30.State = ''DE'')
' 
GO
