IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[All_Policies_All_LOB_15mon_tiein_View_July]'))
DROP VIEW [dbo].[All_Policies_All_LOB_15mon_tiein_View_July]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[All_Policies_All_LOB_15mon_tiein_View_July]'))
...
CREATE VIEW [dbo].[All_Policies_All_LOB_15mon_tiein_View_July]
AS
