IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Policy_Information_ALL_POLICIES_AUTO_February]') AND type in (N'U'))
DROP TABLE [dbo].[Policy_Information_ALL_POLICIES_AUTO_February]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Policy_Information_ALL_POLICIES_AUTO_February]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Policy_Information_ALL_POLICIES_AUTO_February](
 ...
 CONSTRAINT [PK_PI_ALL_Pol_Auto_Feb] PRIMARY KEY CLUSTERED 
(
	[policynumber] ASC
