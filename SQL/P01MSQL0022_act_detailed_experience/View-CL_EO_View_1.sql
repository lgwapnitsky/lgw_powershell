IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[CL_EO_View_1]'))
DROP VIEW [dbo].[CL_EO_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[CL_EO_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.CL_EO_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Latest_All_Lines_View_1.Policy_count_Coverage_Group, dbo.Latest_All_Lines_View_1.Primary_Producer_type, dbo.Latest_All_Lines_View_1.Playground_YN, 
                      ...
                      dbo.Latest_All_Lines_View_1.SLD_BusinessType, dbo.Policy_Information_CL_April.CL_Occ_Limit, dbo.Policy_Information_CL_April.CL_Agg_Limit, 
                      dbo.Policy_Information_CL_April.CL_Deductible, dbo.Policy_Information_CL_April.CL_Revenues, dbo.Policy_Information_CL_April.CL_RetroactiveYears, 
                      dbo.Policy_Information_CL_April.CL_ContractsUsage, dbo.Policy_Information_CL_April.CL_HazardGroup, dbo.Policy_Information_CL_April.CL_ProgramMod_Factor, 
                      dbo.Policy_Information_CL_April.CL_NumOfEmployees, dbo.Policy_Information_CL_April.CL_BusinessType, 
                      dbo.Policy_Information_CL_April.CL_Revenue_Per_Employee, dbo.Policy_Information_CL_April.CL_Mortgage_Broker_Ind, 
                      dbo.Policy_Information_CL_April.CL_NumOfEmployees_range, dbo.Policy_Information_CL_April.CL_Revenues_range, 
                      dbo.Policy_Information_CL_April.CL_Prior_Years_Range, dbo.Policy_Information_CL_April.CL_Revenue_Per_Employee_range, 
                      dbo.Policy_Information_CL_April.CL_Occ_Limit_int, dbo.Policy_Information_CL_April.CL_Agg_Limit_int, dbo.Policy_Information_CL_April.CL_Deductible_int, 
                      dbo.Policy_Information_Underwriting_Check_List_April.CGL_Coverage_YN, dbo.Policy_Information_Underwriting_Check_List_April.Complete_Signed_Application_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_April.Independent_Contractors_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_April.Licensed_Professional_Designations_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_April.Standard_Contract_YN, dbo.Latest_All_Lines_View_1.effectivedate, 
                      ...
                      dbo.Latest_All_Lines_View_1.underwriterName, dbo.Latest_All_Lines_View_1.regiondesc, dbo.Latest_All_Lines_View_1.Written_Premium_Range_for_Product, 
                      dbo.Latest_All_Lines_View_1.accountnumber, dbo.Latest_All_Lines_Losses_View_1.Claim_Desc, dbo.Latest_All_Lines_Losses_View_1.Claim_Number
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      dbo.Latest_All_Lines_Losses_View_1 ON dbo.Latest_All_Lines_View_1.policynumber = dbo.Latest_All_Lines_Losses_View_1.policynumber LEFT OUTER JOIN
                      ...
                      dbo.Policy_Information_CL_April ON dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_CL_April.policynumber
WHERE     (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2008) AND (dbo.Latest_All_Lines_View_1.productcode = ''CL'')
' 
GO
