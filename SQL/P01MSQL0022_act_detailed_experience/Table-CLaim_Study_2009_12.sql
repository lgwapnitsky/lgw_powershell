IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CLaim_Study_2009_12]') AND type in (N'U'))
DROP TABLE [dbo].[CLaim_Study_2009_12]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CLaim_Study_2009_12]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[CLaim_Study_2009_12](
