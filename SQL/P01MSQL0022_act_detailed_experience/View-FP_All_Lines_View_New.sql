IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[FP_All_Lines_View_New]'))
DROP VIEW [dbo].[FP_All_Lines_View_New]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[FP_All_Lines_View_New]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.FP_All_Lines_View_New
AS
SELECT     dbo.ALL_POLICIES_15_premium_summary_B.statecode, dbo.ALL_POLICIES_15_premium_summary_B.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_B.Endorsement_Elite_YN, dbo.Policy_Information_GL_AVG_RATES_B.Schools_FP_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_B.Sales_Service_Orgs_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_B.Offices_FP_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_B.HCF_Phys_Handicap_FP_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_B.Boarding_Rooming_House_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_B.HCF_Phys_Handicap_NP_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_B.Offices_NP_Avg_Rate_Range
...
GROUP BY dbo.ALL_POLICIES_15_premium_summary_B.statecode, dbo.ALL_POLICIES_15_premium_summary_B.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_B.HCF_Phys_Handicap_NP_Avg_Rate_Range, 
                      dbo.Policy_Information_GL_AVG_RATES_B.Offices_NP_Avg_Rate_Range
HAVING      (dbo.Policy_Information_ALL_POLICIES_B.Primary_Umbrella = ''Primary'') AND (dbo.ALL_POLICIES_15_premium_summary_B.productcode = ''FP'')
' 
GO
