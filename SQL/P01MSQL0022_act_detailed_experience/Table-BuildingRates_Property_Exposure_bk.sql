IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BuildingRates_Property_Exposure_bk]') AND type in (N'U'))
DROP TABLE [dbo].[BuildingRates_Property_Exposure_bk]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BuildingRates_Property_Exposure_bk]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[BuildingRates_Property_Exposure_bk](
