IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[NPDO_ALL_Lines_View_2_State_IL_EPLTerrs]'))
DROP VIEW [dbo].[NPDO_ALL_Lines_View_2_State_IL_EPLTerrs]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[NPDO_ALL_Lines_View_2_State_IL_EPLTerrs]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.NPDO_ALL_Lines_View_2_State_IL_EPLTerrs
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_December.statecode, dbo.ALL_POLICIES_12_premium_summary_December.Coverage_Reporting_group, 
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_December.acctngyear, ISNULL(Act_Pricing.dbo.FLEXI_IL_EPL_RatingTerrs_2013.Territory, 
                      ''Remainder of IL'') AS Territory, dbo.Policy_PATHID_Information.Account_ProductType_P, dbo.Policy_PATHID_Information.Account_ProductType_S, 
...
FROM         dbo.ALL_POLICIES_12_premium_summary_December LEFT OUTER JOIN
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_December.statecode = dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_December.statecode AND
                       ...
                       LEFT OUTER JOIN
                      Act_Pricing.dbo.FLEXI_IL_EPL_RatingTerrs_2013 ON 
                      dbo.Policy_PATHID_Information.Insd_Zip = Act_Pricing.dbo.FLEXI_IL_EPL_RatingTerrs_2013.ZIPCode
GROUP BY dbo.ALL_POLICIES_12_premium_summary_December.statecode, dbo.ALL_POLICIES_12_premium_summary_December.policynumber, 
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_December.acctngyear, Act_Pricing.dbo.FLEXI_IL_EPL_RatingTerrs_2013.Territory, 
                      dbo.Policy_PATHID_Information.Account_ProductType_P, dbo.Policy_PATHID_Information.Account_ProductType_S, 
                      dbo.Policy_PATHID_Information.Account_ProductType_U
HAVING      (dbo.Policy_Information_ALL_POLICIES_December.Primary_Umbrella = ''Primary'') AND 
                      (dbo.ALL_POLICIES_12_premium_summary_December.productcode = ''FF'') AND 
                      (dbo.ALL_POLICIES_12_premium_summary_December.Fiscal_AY_Year > 2005) AND 
                      (dbo.ALL_POLICIES_12_premium_summary_December.statecode = ''IL'') AND 
                      (dbo.ALL_POLICIES_12_premium_summary_December.Coverage_Group IN (''D&O'', ''EPL''))
' 
GO
