IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_FL_All_Lines_View_1]'))
DROP VIEW [dbo].[State_FL_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_FL_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_FL_All_Lines_View_1
AS
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_May.statecode, dbo.ALL_POLICIES_12_premium_summary_May.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_AUTO_May.Auto_Vehicle_count_Dual_Control_Percent_Range, 
                      dbo.Policy_Information_ALL_POLICIES_AUTO_May.Non_Owned_Auto, dbo.Policy_Information_ALL_POLICIES_AUTO_May.Hired_Auto
HAVING      (dbo.ALL_POLICIES_12_premium_summary_May.statecode = ''FL'')
' 
GO
