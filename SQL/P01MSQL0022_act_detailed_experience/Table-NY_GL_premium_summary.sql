IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[NY_GL_premium_summary]') AND type in (N'U'))
DROP TABLE [dbo].[NY_GL_premium_summary]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[NY_GL_premium_summary]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[NY_GL_premium_summary](
	...
	[GL_Territory_Dominant] [varchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
