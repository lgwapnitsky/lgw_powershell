IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BD_Loss_Detail_Information_1]') AND type in (N'U'))
DROP TABLE [dbo].[BD_Loss_Detail_Information_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BD_Loss_Detail_Information_1]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[BD_Loss_Detail_Information_1](
