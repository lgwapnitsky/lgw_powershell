IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Price_Monitor_Data_for_mental_health_Tiein_Reporting]') AND type in (N'U'))
DROP TABLE [dbo].[Price_Monitor_Data_for_mental_health_Tiein_Reporting]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Price_Monitor_Data_for_mental_health_Tiein_Reporting]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Price_Monitor_Data_for_mental_health_Tiein_Reporting](
