IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Producer_View_1]'))
DROP VIEW [dbo].[Producer_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Producer_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.Producer_View_1
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_June.statecode, dbo.ALL_POLICIES_12_premium_summary_June.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_June.Account_Dominant_Product_Group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_June.Primary_Producer_type, dbo.Policy_Information_ALL_POLICIES_GL_June.policynumber AS Expr3, 
                      dbo.Policy_Information_ALL_POLICIES_GL_June.GL_Occurrence_Limit AS Expr4, 
                      dbo.Policy_Information_ALL_POLICIES_GL_June.GL_Aggregate_Limit AS Expr5, 
                      dbo.Policy_Information_ALL_POLICIES_GL_June.GL_Deductible AS Expr6, dbo.Policy_Information_ALL_POLICIES_GL_June.GLDX_Indicator AS Expr7, 
                      dbo.Policy_Information_ALL_POLICIES_GL_June.SAM_OCC_Limit, dbo.Policy_Information_ALL_POLICIES_GL_June.SAM_Form, 
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_June.TIV, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_RepLoss_Ratio_Working_Cover_Range, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_RepLoss_Ratio_Working_Cover, 
                      dbo.Policy_Information_ALL_POLICIES_June.Primary_Producer_code, dbo.Policy_Information_ALL_POLICIES_June.PIC_Producer_code, 
                      dbo.Policy_Information_ALL_POLICIES_June.PIC_Producer, SUM(dbo.ALL_POLICIES_12_premium_summary_June.Policy_count_All_Cov_Combined) 
                      AS Policy_count_All_Cov_Combined
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_June.statecode, dbo.ALL_POLICIES_12_premium_summary_June.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_June.Business_Name, dbo.Policy_Information_ALL_POLICIES_June.Commission_pct, 
                      dbo.Policy_Information_ALL_POLICIES_June.Review_quarter, dbo.Policy_Information_ALL_POLICIES_June.Account_Dominant_Product, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_Name, dbo.ALL_POLICIES_12_premium_summary_June.accountnumber, 
                      dbo.ALL_POLICIES_12_premium_summary_June.policynumber, dbo.Policy_Information_ALL_POLICIES_June.policy_effective_year, 
                      dbo.Policy_Information_ALL_POLICIES_June.Account_Dominant_Product_Group, 
                      dbo.Policy_Information_ALL_POLICIES_June.Count_of_Account_Numbers_Range, dbo.Policy_Information_ALL_POLICIES_June.Primary_Producer, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_June.Account_RepLoss_Ratio_Working_Cover, 
                      dbo.Policy_Information_ALL_POLICIES_June.Primary_Producer_code, dbo.Policy_Information_ALL_POLICIES_June.PIC_Producer_code, 
                      dbo.Policy_Information_ALL_POLICIES_June.PIC_Producer
HAVING      (dbo.Policy_Information_ALL_POLICIES_June.Primary_Producer_code = 16245) AND 
                      (dbo.ALL_POLICIES_12_premium_summary_June.productcode = ''DY'')
' 
GO
