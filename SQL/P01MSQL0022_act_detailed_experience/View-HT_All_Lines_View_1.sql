IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[HT_All_Lines_View_1]'))
DROP VIEW [dbo].[HT_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[HT_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.HT_All_Lines_View_1
AS
SELECT     dbo.Latest_All_Lines_View_1.statecode, dbo.Latest_All_Lines_View_1.Coverage_Reporting_group, dbo.Latest_All_Lines_View_1.productcode, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_June.Clubs_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_June.Driving_Range_Avg_Rate_Range, 
                      ...
                      dbo.Policy_Information_Underwriting_Check_List_June.Liquor_Liability_YN, dbo.Policy_Information_GL_AVG_RATES_June.Swimming_Pools_Avg_Rate_Range, 
...
FROM         dbo.Latest_All_Lines_View_1 LEFT OUTER JOIN
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_June ON dbo.Latest_All_Lines_View_1.policynumber = dbo.Policy_Information_GL_AVG_RATES_June.Policynumber
WHERE     (dbo.Latest_All_Lines_View_1.productcode = ''ht'') AND (dbo.Latest_All_Lines_View_1.Fiscal_AY_Year > 2007)
' 
GO
