IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Policy_Product_State_Coverage_Data_ALL_POLICIES_December_test]') AND type in (N'U'))
DROP TABLE [dbo].[Policy_Product_State_Coverage_Data_ALL_POLICIES_December_test]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Policy_Product_State_Coverage_Data_ALL_POLICIES_December_test]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[Policy_Product_State_Coverage_Data_ALL_POLICIES_December_test](
	...
	[AL_Territory_Dominant] [varchar](200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[AL_Territory_Dominant_percent] [varchar](200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[AL_Dom_Terr_description] [varchar](200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[AL_Dom_Region_in_State] [varchar](200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[classcode] [varchar](6) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[FA_Territory_Dominant] [varchar](200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[FA_Territory_Dominant_percent] [varchar](200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[FA_Dom_Terr_description] [varchar](200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[FA_Dom_Region_in_State] [varchar](200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
END
GO
