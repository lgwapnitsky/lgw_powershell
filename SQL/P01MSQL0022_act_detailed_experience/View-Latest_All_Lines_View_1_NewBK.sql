IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_All_Lines_View_1_NewBK]'))
DROP VIEW [dbo].[Latest_All_Lines_View_1_NewBK]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[Latest_All_Lines_View_1_NewBK]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.Latest_All_Lines_View_1_NewBK
AS
...
FROM         Act_Pricing.dbo.DNB_Mar2011_Final RIGHT OUTER JOIN
                      ...
                      Act_Pricing.dbo.DNB_Mar2011_Final.EFFECTIVE_DATE = dbo.Policy_Information_ALL_POLICIES_March.policyEffectivedate AND 
                      Act_Pricing.dbo.DNB_Mar2011_Final.ACCOUNT_NUMBER = dbo.Policy_Information_ALL_POLICIES_March.accountnumber AND 
                      Act_Pricing.dbo.DNB_Mar2011_Final.POLICY_YEAR = dbo.Policy_Information_ALL_POLICIES_March.policy_effective_year RIGHT OUTER JOIN
                      dbo.ALL_POLICIES_12_premium_summary_March LEFT OUTER JOIN
                      dbo.Policy_Information_Underwriting_Check_List_March ON 
                      dbo.ALL_POLICIES_12_premium_summary_March.policyeffectivedate = dbo.Policy_Information_Underwriting_Check_List_March.policyeffectivedate AND 
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_March.Coverage_Group = dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_March.coverage_group ON 
                      dbo.Policy_Information_ALL_POLICIES_March.policynumber = dbo.ALL_POLICIES_12_premium_summary_March.policynumber AND 
                      dbo.Policy_Information_ALL_POLICIES_March.Productcode = dbo.ALL_POLICIES_12_premium_summary_March.productcode AND 
                      dbo.Policy_Information_ALL_POLICIES_March.policyEffectivedate = dbo.ALL_POLICIES_12_premium_summary_March.policyeffectivedate LEFT OUTER JOIN
