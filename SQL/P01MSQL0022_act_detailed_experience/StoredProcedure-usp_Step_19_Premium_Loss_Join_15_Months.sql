IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_Step_19_Premium_Loss_Join_15_Months]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_Step_19_Premium_Loss_Join_15_Months]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_Step_19_Premium_Loss_Join_15_Months]') AND type in (N'P', N'PC'))
BEGIN
...
CREATE procedure [dbo].[usp_Step_19_Premium_Loss_Join_15_Months] as
...
from Act_Detailed_Experience.dbo.ALL_POLICIES_15_Detail_Information_2_work AL1
left join Act_Detailed_Experience.dbo.ALL_POLICIES_15_premium_summary_work PS
...
/* Add Loss fields to PremiumSummary table */

IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N''[dbo].[ALL_POLICIES_15_premium_summary_temp]'') AND type in (N''U''))
drop table Act_Detailed_Experience.dbo.ALL_POLICIES_15_premium_summary_temp
...
into Act_Detailed_Experience.dbo.ALL_POLICIES_15_premium_summary_temp
from Act_Detailed_Experience.dbo.ALL_POLICIES_15_premium_summary_work PS
left outer join Act_Detailed_Experience.dbo.ALL_POLICIES_15_Detail_Information_2_work AL
...
left outer join Act_Detailed_Experience.dbo.ALL_POLICIES_15_Detail_Information_3_work AL3 
...
insert into Act_Detailed_Experience.dbo.ALL_POLICIES_15_premium_summary_temp
select
...
from Act_Detailed_Experience.dbo.ALL_POLICIES_15_Detail_Information_3_work AL1
left join Act_Detailed_Experience.dbo.ALL_POLICIES_15_premium_summary_temp PS
on PS.policynumber = AL1.policynumber
	and PS.experienceproduct = AL1.ExperienceProduct
...
drop table ALL_POLICIES_15_premium_summary_work 
...
select [accountnumber]
      ...
      ,[Earned_TIV_Total]
  into Act_Detailed_Experience.dbo.ALL_POLICIES_15_premium_summary_temp2
from Act_Detailed_Experience.dbo.ALL_POLICIES_15_premium_summary_temp PS
left outer join Act_Definitions.dbo.Product_Groups_Exp EP
on EP.Exp_product = ps.experienceproduct

drop table ALL_POLICIES_15_premium_summary_temp

exec sp_rename ''ALL_POLICIES_15_premium_summary_temp2'', ''ALL_POLICIES_15_premium_summary_work''
