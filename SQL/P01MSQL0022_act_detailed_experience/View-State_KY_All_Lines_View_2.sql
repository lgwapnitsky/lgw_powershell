IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_KY_All_Lines_View_2]'))
DROP VIEW [dbo].[State_KY_All_Lines_View_2]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_KY_All_Lines_View_2]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_KY_All_Lines_View_2
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_October.statecode, dbo.ALL_POLICIES_12_premium_summary_October.Coverage_Reporting_group, 
                      ...
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.Capped_Incurred_Loss_ALAE_with_SS_wo_cat) AS Capped_Incurred_Loss_ALAE_with_SS_wo_cat, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.Ult_LDF_Incurred_Loss_ALAE_with_SS_NonCat) AS Ult_LDF_Incurred_Loss_ALAE_with_SS_NonCat, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.Ult_LDF_Capped_Incurred_Loss_ALAE_with_SS_wo_cat) 
                      AS Ult_LDF_Capped_Incurred_Loss_ALAE_with_SS_wo_cat, SUM(dbo.ALL_POLICIES_12_premium_summary_October.Reported_Claims) AS Reported_Claims, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_Malpractice_Count) AS COL_GLBI_Malpractice_Count, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_Malpractice_Loss) AS COL_GLBI_Malpractice_Loss, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_Fraud_Breach_of_Contract_Count) AS COL_GLBI_Fraud_Breach_of_Contract_Count, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_Fraud_Breach_of_Contract_Loss) AS COL_GLBI_Fraud_Breach_of_Contract_Loss, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_Injury_Count) AS COL_GLBI_Injury_Count, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_Injury_Loss) AS COL_GLBI_Injury_Loss, 
                      ...
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_Sexual_Assault_Molest_Abuse_Count) AS COL_GLBI_Sexual_Assault_Molest_Abuse_Count, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_Sexual_Assault_Molest_Abuse_Loss) AS COL_GLBI_Sexual_Assault_Molest_Abuse_Loss, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_PropertyDamage_Loss) AS COL_GLBI_PropertyDamage_Loss, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_PropertyDamage_Count) AS COL_GLBI_PropertyDamage_Count, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_Theft_Loss) AS COL_GLBI_Theft_Loss, 
                      ...
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_Discrim_WrongfulTermination_Loss) AS COL_GLBI_Discrim_WrongfulTermination_Loss, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.COL_GLBI_Discrim_WrongfulTermination_Count) AS COL_GLBI_Discrim_WrongfulTermination_Count, 
                      SUM(dbo.ALL_POLICIES_12_premium_summary_October.Incurred_Claims) AS Incurred_Claims, 
                      ...
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_October.GL_Dom_Region_in_State, dbo.Policy_Information_ALL_POLICIES_October.Primary_Producer, 
                      ...
                      dbo.Policy_Information_Underwriting_Check_List_October.Playground_YN, dbo.Policy_Information_Underwriting_Check_List_October.Playground_Equip_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Pool_YN, dbo.Policy_Information_Underwriting_Check_List_October.Sports_Activities_YN, 
                      dbo.Policy_Information_Underwriting_Check_List_October.Tennis_Bubble_YN, dbo.Policy_Information_Underwriting_Check_List_October.Tennis_Courts_YN, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_October.Property_Coverage_Form, dbo.ALL_POLICIES_12_premium_summary_October.Coverage_Form, 
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_October.FA_Constr_Code_Dominant_NAME, 
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_October.FA_Hail_Dominant, dbo.Policy_Information_ALL_POLICIES_FireAllied_October.ZIP_Pop_Density_Dominant, 
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_October.FA_Avg_Bld_Rate_Range, 
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_October.FA_Avg_Bld_Rate_rd2, dbo.Policy_Information_ALL_POLICIES_FireAllied_October.FA_Deductible, 
                      ...
                      dbo.Policy_Information_GL_AVG_RATES_October.Churches_Avg_Rate_Range, dbo.Policy_Information_GL_AVG_RATES_October.Day_Care_Avg_Rate_Range, 
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_October.Fiscal_AY_Month_Ending, dbo.ALL_POLICIES_12_premium_summary_October.Last_Reporting_Year, 
                      dbo.ALL_POLICIES_12_premium_summary_October.Last_Reporting_Month, dbo.Policy_Information_ALL_POLICIES_October.PIC_Producer, 
                      dbo.Policy_Information_ALL_POLICIES_October.First_Policy_Year, dbo.Policy_Information_ALL_POLICIES_October.underwriter, 
                      dbo.Policy_Information_ALL_POLICIES_October.BusinessClassDesc, dbo.Policy_Information_ALL_POLICIES_October.Source_Detail_Name
FROM         dbo.ALL_POLICIES_12_premium_summary_October LEFT OUTER JOIN
                      AccessPHLYEOM.dbo.product ON dbo.ALL_POLICIES_12_premium_summary_October.productcode = AccessPHLYEOM.dbo.product.productcode LEFT OUTER JOIN
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_October.policynumber = dbo.Policy_Information_Underwriting_Check_List_October.policynumber LEFT OUTER JOIN
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_October.policynumber = dbo.Policy_Information_ALL_POLICIES_FireAllied_October.policynumber LEFT OUTER JOIN
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_October.statecode, dbo.ALL_POLICIES_12_premium_summary_October.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Product_State_Coverage_Data_ALL_POLICIES_October.GL_Dom_Region_in_State, dbo.Policy_Information_ALL_POLICIES_October.Primary_Producer, 
                      dbo.Policy_Information_ALL_POLICIES_October.Account_UltLoss_Ratio_Working_Cover_Range, 
                      dbo.Policy_Information_ALL_POLICIES_October.Account_RepLoss_Ratio_Working_Cover_Range, dbo.Policy_Information_ALL_POLICIES_October.accountnumber, 
                      ...
                      dbo.Policy_Information_Underwriting_Check_List_October.Sports_Activities_YN, dbo.Policy_Information_Underwriting_Check_List_October.Tennis_Bubble_YN, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_October.First_Policy_Year, dbo.Policy_Information_ALL_POLICIES_October.underwriter, 
                      dbo.Policy_Information_ALL_POLICIES_October.BusinessClassDesc, dbo.Policy_Information_ALL_POLICIES_October.Source_Detail_Name
HAVING      (dbo.ALL_POLICIES_12_premium_summary_October.statecode = ''KY'')
' 
GO
