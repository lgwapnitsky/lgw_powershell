IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[All_Policies_All_LOB_15mon_tiein_View_February]'))
DROP VIEW [dbo].[All_Policies_All_LOB_15mon_tiein_View_February]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[All_Policies_All_LOB_15mon_tiein_View_February]'))
...
CREATE VIEW [dbo].[All_Policies_All_LOB_15mon_tiein_View_February]
AS
...
FROM         dbo.ALL_POLICIES_15_premium_summary_February
