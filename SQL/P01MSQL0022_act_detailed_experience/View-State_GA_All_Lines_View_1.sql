IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_GA_All_Lines_View_1]'))
DROP VIEW [dbo].[State_GA_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_GA_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_GA_All_Lines_View_1
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_April.statecode, dbo.ALL_POLICIES_12_premium_summary_April.Coverage_Reporting_group, 
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_April.Fiscal_AY_Month_Ending, dbo.Policy_Information_ALL_POLICIES_April.underwriter, 
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_April.statecode, dbo.ALL_POLICIES_12_premium_summary_April.Coverage_Reporting_group, 
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_April.Fiscal_AY_Month_Ending, dbo.Policy_Information_ALL_POLICIES_April.underwriter, 
                      dbo.Policy_Information_ALL_POLICIES_April.First_Policy_Year
HAVING      (dbo.ALL_POLICIES_12_premium_summary_April.statecode = ''GA'')
' 
GO
