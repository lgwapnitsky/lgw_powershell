IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_OH_All_Lines_View_1]'))
DROP VIEW [dbo].[State_OH_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_OH_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_OH_All_Lines_View_1
AS
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_May.statecode, dbo.ALL_POLICIES_12_premium_summary_May.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_FireAllied_May.FA_Avg_Bld_Rate_rd2, dbo.Policy_Information_ALL_POLICIES_FireAllied_May.FA_Deductible, 
                      dbo.Policy_Information_ALL_POLICIES_May.Endorsement_Elite_YN, dbo.Policy_Information_ALL_POLICIES_May.Account_Name
HAVING      (dbo.ALL_POLICIES_12_premium_summary_May.statecode = ''OH'')
' 
GO
