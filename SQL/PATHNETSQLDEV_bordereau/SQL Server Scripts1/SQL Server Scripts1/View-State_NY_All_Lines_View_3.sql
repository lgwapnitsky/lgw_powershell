IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_NY_All_Lines_View_3]'))
DROP VIEW [dbo].[State_NY_All_Lines_View_3]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_NY_All_Lines_View_3]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_NY_All_Lines_View_3
AS
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_March.statecode, dbo.ALL_POLICIES_12_premium_summary_March.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_March.First_Policy_Year, dbo.Policy_Information_ALL_POLICIES_March.underwriter, 
                      dbo.Policy_Information_ALL_POLICIES_March.BusinessClassDesc, dbo.Policy_Information_ALL_POLICIES_March.Source_Detail_Name
HAVING      (dbo.ALL_POLICIES_12_premium_summary_March.statecode = ''NY'')
' 
GO
