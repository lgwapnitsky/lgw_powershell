IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_OH_All_Lines_Losses_View_2]'))
DROP VIEW [dbo].[State_OH_All_Lines_Losses_View_2]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_OH_All_Lines_Losses_View_2]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_OH_All_Lines_Losses_View_2
AS
SELECT     dbo.ALL_POLICIES_12_Detail_Information_1_October.Accountnumber, dbo.ALL_POLICIES_12_Detail_Information_1_October.Policy_Number, 
                      ...
                      dbo.ALL_POLICIES_12_Detail_Information_1_October.Type_of_Loss, dbo.Policy_Information_ALL_POLICIES_October.Written_Premium_Range, 
...
WHERE     (dbo.ALL_POLICIES_12_Detail_Information_1_October.Premium_State = ''OH'')
' 
GO
