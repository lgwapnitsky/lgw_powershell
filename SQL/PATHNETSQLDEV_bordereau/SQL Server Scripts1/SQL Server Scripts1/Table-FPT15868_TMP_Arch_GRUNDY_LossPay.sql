IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[FPT15868_TMP_Arch_GRUNDY_LossPay]') AND type in (N'U'))
DROP TABLE [dbo].[FPT15868_TMP_Arch_GRUNDY_LossPay]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[FPT15868_TMP_Arch_GRUNDY_LossPay]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[FPT15868_TMP_Arch_GRUNDY_LossPay](
	[Arch_GRUNDY_LossPay_ID] [int] NOT NULL,
