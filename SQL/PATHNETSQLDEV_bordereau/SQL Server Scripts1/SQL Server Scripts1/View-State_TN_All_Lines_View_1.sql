IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_TN_All_Lines_View_1]'))
DROP VIEW [dbo].[State_TN_All_Lines_View_1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[State_TN_All_Lines_View_1]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.State_TN_All_Lines_View_1
AS
SELECT     dbo.ALL_POLICIES_12_premium_summary_May.statecode, dbo.ALL_POLICIES_12_premium_summary_May.Coverage_Reporting_group, 
                      ...
                      dbo.ALL_POLICIES_12_premium_summary_May.Last_Reporting_Month, dbo.Policy_Information_ALL_POLICIES_May.ProductType, 
                      dbo.Policy_Information_ALL_POLICIES_May.DivisionName
...
GROUP BY dbo.ALL_POLICIES_12_premium_summary_May.statecode, dbo.ALL_POLICIES_12_premium_summary_May.Coverage_Reporting_group, 
                      ...
                      dbo.Policy_Information_ALL_POLICIES_May.Account_Name, dbo.ALL_POLICIES_12_premium_summary_May.Fiscal_AY_Month_Ending, 
                      dbo.ALL_POLICIES_12_premium_summary_May.Last_Reporting_Year, dbo.ALL_POLICIES_12_premium_summary_May.Last_Reporting_Month, 
                      dbo.Policy_Information_ALL_POLICIES_May.ProductType, dbo.Policy_Information_ALL_POLICIES_May.DivisionName
HAVING      (dbo.ALL_POLICIES_12_premium_summary_May.statecode = ''TN'')
' 
GO
